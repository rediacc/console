...
//
// The tail of the config, and the two things that belong at a tail: rules that
// are switched off for a whole CLASS of file with the measurement that justified
