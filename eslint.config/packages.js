...
//
// private/account, packages/www, packages/json and the scripts/ tree. These are
// the blocks whose reason for existing is a package boundary rather than a rule
...
export default [
  ...
  // It used to say "line 909", which had already drifted to a line in the TEST
  // FILE OVERRIDES banner long before this file was split out of the single
  // config. A line number in a comment is a reference that rots silently, so
  // this one names the block instead.
