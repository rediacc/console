// AUTO-GENERATED by packages/cli/scripts/generate-cli-contract.ts - DO NOT EDIT Run: npm run generate:cli-contract -w @rediacc/cli Source: the live Commander tree + COMMAND_METADATA + command-registry + i18n
...
export const CLI_CONTRACT: CliContract = {
  ...
  "commands": [
    ...
    },
    {
      ...
      "pathKey": "backup strategy bind",
      "domain": "backup",
      "group": "INFRASTRUCTURE",
      "plane": "config",
      "descriptionKey": "commands.backup.strategy.bind.description",
      "label": "Bind a backup strategy to a machine so its schedule is deployed there",
      "options": [
        {
          "flags": "-m, --machine <name>",
          "long": "machine",
    ...
    },
    {
      ...
      "pathKey": "backup strategy unbind",
      "domain": "backup",
      "group": "INFRASTRUCTURE",
      "plane": "config",
      "descriptionKey": "commands.backup.strategy.unbind.description",
      "label": "Unbind a backup strategy from a machine",
      "options": [
        {
          "flags": "-m, --machine <name>",
          "long": "machine",
    ...
    },
    {
      ...
      "label": "List all clusters, or pass a cluster name to show that cluster's full config.",
      "options": [],
      "positionals": [
        {
          "name": "cluster",
      ...
      "options": [
        {
          ...
          "label": "Repository to diff against (the base / old side); defaults to the parent of <ref>"
        },
        {
          "flags": "--name-only",
          "long": "name-only",
    ...
    },
    {
      ...
      "positionals": [
        ...
        },
        {
          ...
          "label": "Command to run: everything after -- is sent to the container verbatim, so CLI flags (-c, -i, -u, --debug) must come before --"
        }
      ],
      "hasSubcommands": false,
      "examples": [
        ...
        },
        {
          ...
          "label": "Pass flags to the remote command: put them after --, and keep the CLI's own flags before it."
        }
      ],
      "keywords": [
        "run",
