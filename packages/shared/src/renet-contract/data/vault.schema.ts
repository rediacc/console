// AUTO-GENERATED by renet functions generate-types - DO NOT EDIT Run: ./build.sh deploy prep Source: renet/pkg/functions/vault/
...
/** Complete RenetVault schema */
export const RenetVaultSchema = z.object({
...
export type RenetVaultType = z.infer<typeof RenetVaultSchema>;

export type VaultValidationResult = ZodSafeParseResult<RenetVaultType>;

/**
 * Validates a queue vault object against the schema.
 * Returns a Zod SafeParseResult.
 */
export function validateRenetVault(vault: unknown): VaultValidationResult {
  return RenetVaultSchema.safeParse(vault);
}

/**
 * Parses and validates a queue vault, throwing on error.
 */
export function parseRenetVault(vault: unknown): RenetVaultType {
  return RenetVaultSchema.parse(vault);
}
