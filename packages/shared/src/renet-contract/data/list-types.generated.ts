// AUTO-GENERATED by renet functions generate-types - DO NOT EDIT Run: ./build.sh deploy prep Source: renet/pkg/list/types.go

// ============================================
// Machine status types from 'renet list all --json'
// ============================================

export const LIST_TYPES_VERSION = 'v1.2.25';
...
/** One dm-thin fork-overlay pool's data/metadata fill (spike f) */
export interface ThinPoolHealth {
  data_total_blocks: number;
  data_used_blocks: number;
  data_used_percent: number;
  metadata_total_blocks: number;
  metadata_used_blocks: number;
