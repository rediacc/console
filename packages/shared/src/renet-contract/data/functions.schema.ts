...
export const RepositoryUpAllParamsSchema = z.object({
  ...
  mountOnly: z.boolean().optional().describe('Only mount, do not start services'),
...
} satisfies Record<RenetFunctionName, z.ZodType<FunctionParamsMap[RenetFunctionName]>>;

export function validateFunctionParams<F extends RenetFunctionName>(
  functionName: F,
  params: unknown
): FunctionParamsMap[F] {
...
export function safeValidateFunctionParams<F extends RenetFunctionName>(
  functionName: F,
  params: unknown
...
export function isValidParams<F extends RenetFunctionName>(
  functionName: F,
  params: unknown
