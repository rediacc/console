...
import type { AuditHistoryEntry, AuditLogEntry, AuditTraceResponse, AuditTraceRecord, AuditTraceSummary } from '../../types'
...
export function createAuditService(client: ApiClient) {
  return {
    ...
    getEntityHistory: async (entityType: string, entityName: string): Promise<AuditHistoryEntry[]> => {
