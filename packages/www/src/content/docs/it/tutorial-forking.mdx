...
description: "Clona un intero repository (app, database, file) in pochi secondi. Qualsiasi dimensione. Zero disco aggiuntivo."
category: "Tutorials"
tags:
  - forking
  - repositories
...
![Condividere un link a una cartella ha la stessa velocità indipendentemente dalla dimensione della cartella](/img/tutorials/tutorial-forking/slide-2.svg)
...
![Un fork è una fotografia congelata; il parent continua a scorrere come un fiume](/img/tutorials/tutorial-forking/slide-5.svg)
...
Successivo: [L'Isolamento del Fork in Azione](/it/docs/tutorial-fork-isolation).
