...
| `rdc backup manifests <repo-ref>` | Parça depolamanın tuttuğu anlık görüntüleri listele |
| `rdc backup browse <repo-ref>` | Bir deponun içerdiği dosyaları listele (yerel, salt okunur) |
