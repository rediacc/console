...
Depoda hâlâ çalışan bir `renet dev up` oturumunuz varsa, önce `rdc vscode connect my-app` ardından `renet dev down` ile durdurun. Bundan sonra her şey tamamen dizüstü bilgisayarınızdan yönetilir.
