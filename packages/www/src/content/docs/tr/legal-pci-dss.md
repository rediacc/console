...
PCI DSS, segmentasyona sert biçimde yaslanır: kart sahibi veri ortamını (CDE) izole edin, yoksa denetimi geçemeyin. Rediacc bu segmentasyonu varsayılan olarak sağlar:
...
Zayıf segmentasyon ve eksik şifreleme, en maliyetli PCI DSS uygulama işlemlerinin arkasındadır:
