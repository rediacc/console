...
5. **{{t:common.actions.export}}** düğmesini tıklayın ve format seçin: **CSV** veya **JSON**.
...
4. **{{t:common.actions.export}}** düğmesine tıklayarak CSV veya JSON formatında dışa aktarın.
...
6. Aşamaları izleyin: **{{t:queue.statusAssigned}}** → **{{t:queue.statusProcessing}}** → **{{t:queue.statusCompleted}}**
...
5. Görev takip penceresinde aşamaları izleyin: **{{t:queue.statusAssigned}}** → **{{t:queue.statusProcessing}}** → **{{t:queue.statusCompleted}}**
...
4. **{{t:common.actions.export}}** düğmesinden format seçin: **CSV** veya **JSON**.
