...
2. Click the shield icon in the actions column (**Permissions**).

![Permission management - shield, gear, and delete icons](/assets/images/UserGuideEng/10_users_permissions.png)
...
![Permission assignment modal - Administrators group](/assets/images/UserGuideEng/11_user_permissions_form.png)
...
![User trace - "Trace" tooltip with action button](/assets/images/UserGuideEng/14_users_trace.png)
...
![Team editing form - blue info message](/assets/images/UserGuideEng/17_teams_edit_form.png)
...
![Team members management form - "Current Members" and "Add Member" tabs](/assets/images/UserGuideEng/18_teams_members_form.png)
...
![Connectivity Test button](/assets/images/UserGuideEng/26_connectivity_test_button.png)
...
![Refresh button](/assets/images/UserGuideEng/28_refresh.png)
...
![View Details button](/assets/images/UserGuideEng/29_view_details_button.png)
...
![Machine detail panel - system information](/assets/images/UserGuideEng/30_machine_view_details.png)
...
![Edit button](/assets/images/UserGuideEng/31_edit_button.png)
...
![Machine editing form](/assets/images/UserGuideEng/32_edit_form.png)
...
![Trace button](/assets/images/UserGuideEng/33_trace_button.png)
...
![Delete button](/assets/images/UserGuideEng/35_delete_button.png)
*(Figure 35: Trash can icon in machine actions column)*

3. Click the **{{t:common.delete}}** button in the confirmation window.

![Machine deletion confirmation window](/assets/images/UserGuideEng/36_delete_form.png)
...
![Advanced functions list](/assets/images/UserGuideEng/41_remote_advanced.png)
...
![Remote menu - Test Connection](/assets/images/UserGuideEng/42_connectivity_test.png)
...
![Repository list](/assets/images/UserGuideEng/46_repo_list.png)
...
![Fork completed](/assets/images/UserGuideEng/49_repo_completed.png)
...
![Up completed](/assets/images/UserGuideEng/51_repo_up_complete.png)
...
![Down completed](/assets/images/UserGuideEng/53_down_completed.png)
...
![Deploy completed](/assets/images/UserGuideEng/56_deploy_completed.png)
...
![Backup completed](/assets/images/UserGuideEng/59_backup_completed.png)
...
1. Select the repository and follow the **fx** > **Templates** path.

![Templates operation](/assets/images/UserGuideEng/60_templates_button.png)
...
![Template applied](/assets/images/UserGuideEng/62_templates_completed.png)
...
![Unmount completed](/assets/images/UserGuideEng/64_unmount_completed.png)
...
![Expand form](/assets/images/UserGuideEng/66_expand_form.png)
...
![Expand completed](/assets/images/UserGuideEng/67_expand_completed.png)
...
![Rename form](/assets/images/UserGuideEng/69_rename_form.png)
...
![View Details button](/assets/images/UserGuideEng/71_repo_view_button.png)
...
![Desktop application open permission](/assets/images/UserGuideEng/75_desktop_open_page.png)
...
![Trace button](/assets/images/UserGuideEng/83_credentials_trace_button.png)
...
![Delete button](/assets/images/UserGuideEng/85_credentials_delete.png)
*(Figure 85: Red "Delete" button on Credentials page)*

3. Click the **{{t:common.delete}}** button in the confirmation window.

![Deletion confirmation](/assets/images/UserGuideEng/86_credentials_delete_confirm.png)
...
![Audit list](/assets/images/UserGuideEng/89_audit_list.png)
