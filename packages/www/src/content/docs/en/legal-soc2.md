...
| **Availability** (A1) | System recovery and resilience | `rdc repo backup push/pull` with encrypted offsite copies to SSH, S3, B2, Azure, or GDrive. CoW snapshots for instant rollback. Fork-based upgrades for zero-downtime changes. |
