...
각 조직에는 다음이 포함됩니다:
- 고유한 이름 (기본값: 이메일 주소)
- 구독 플랜 (신규 계정은 Professional 또는 Business 요금제로 14일 무료 체험이 시작됩니다. 자세한 내용은 아래 "구독 및 플랜" 참고)
...
|------|---------|-------------------|------------------------|------|
| COMMUNITY | 1 | 100 | 15d / 30d | 기본 |
| PROFESSIONAL | 1 | 2,000+ | 60d / 120d | 권한 그룹, 감사 로그, 커스텀 브랜딩, 우선 지원 |
| BUSINESS | 1 | 5,000+ | 90d / 180d | Ceph, 고급 분석, 대기열 우선순위, 고급 대기열 |
| ENTERPRISE | 맞춤형 | 15,000+ | 120d / 365d | 전담 계정 매니저 |

![Subscription Flow](/img/account-subscription-flow.svg)

Professional과 Business는 셀프 서비스 요금제이며 각각 머신 1대가 포함됩니다. 여러 대의 머신이 필요한 Enterprise는 파트너를 통해 판매됩니다. 신규 가입자는 Professional 또는 Business 요금제로 14일 무료 체험이 자동으로 시작되며, 가입 시 신용카드 정보를 등록하지만 실제 결제는 체험 기간이 끝날 때 처음 발생합니다. 체험 중 해지하거나, 이후 유료 요금제를 해지하거나, 결제에 실패하면 계정은 무료 Community 요금제(머신 1대, 저장소당 10GB, 월 100회 설정)로 전환됩니다. 모든 플랜은 3일 유예 기간으로 시작합니다. 머신 슬롯은 팀별로 추적되며 비활성 상태 5시간 후 자동으로 해제됩니다. 자세한 내용은 [구독 및 라이선싱](/en/docs/subscription-licensing)을 참조하세요.

### 결제

조직 **소유자**만 결제를 관리할 수 있습니다:
- 플랜 시작 또는 업그레이드를 위한 Stripe 체크아웃 세션 생성
- 결제 수단 변경을 위한 Stripe 청구 포털 접근
- 청구 포털에서 플랜 해지 또는 변경 (해지 시 무료 Community 플랜으로 전환)
