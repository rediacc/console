...
| 비즈니스 연속성 (제21조(2)(c)) | `rdc repo push/pull`을 사용한 다중 목적지 암호화 백업. 즉각적인 롤백을 위한 CoW 스냅샷. |
...
| 대응 및 복구 (제11조) | 즉각적인 롤백을 위한 CoW 스냅샷. 다중 목적지 복구를 위한 `rdc repo push/pull`. 포크 기반 재해 복구 테스트. |
