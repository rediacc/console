---
title: "PCI DSS 준수"
description: "Rediacc가 결제 카드 데이터 보호를 위한 PCI DSS 요구사항에 어떻게 부합하는지 암호화, 네트워크 분리, 접근 제어 측면에서 설명합니다."
category: "Legal"
order: 6
language: ko
...
PCI DSS는 분리를 강하게 요구합니다. 카드 소유자 데이터 환경(CDE)을 격리하거나 감사에서 실패합니다. Rediacc는 기본적으로 이 분리를 제공합니다.
...
미흡한 분리와 암호화 누락이 가장 큰 PCI DSS 제재 조치의 배경입니다.

- Heartland Payment Systems(2008년): 공격자가 미흡한 네트워크 분리로 인해 48개 데이터베이스에 걸쳐 측면 이동하여 1억 3천만 개의 카드 번호를 노출했습니다. [총 비용은 2억 달러를 초과했습니다.](https://www.philadelphiafed.org/-/media/frbp/assets/consumer-finance/discussion-papers/d-2010-january-heartland-payment-systems.pdf)
