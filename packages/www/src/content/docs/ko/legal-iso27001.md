...
| **A.12**, 운영 보안 | A.12.3 백업 | `rdc repo push/pull`을 사용한 여러 목적지(SSH, S3, B2, Azure, GDrive)로의 암호화 오프사이트 저장. 시점 복구를 위한 CoW 스냅샷. `rdc repo validate`로 백업 상태 및 리포지토리 무결성 검증. |
