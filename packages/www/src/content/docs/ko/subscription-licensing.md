...
워크스테이션 대 서버 분할에 대해서는 [rdc vs renet](/en/docs/rdc-vs-renet)을 참고하고, 저장소 라이프사이클 자체에 대해서는 [Repositories](/en/docs/repositories)를 참고하세요.
...
- 정말로 만료된 저장소 라이선스는 크기 조정/확장 전에 `rdc`를 통해 새로 고쳐야 합니다
