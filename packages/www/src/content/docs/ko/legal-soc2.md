---
title: "SOC 2 준수"
description: "Rediacc가 SOC 2 증거를 제공하는 부분: 로그, 변경 관리 추적, 그리고 감사인이 요구하는 통제들."
category: "Legal"
order: 2
language: ko
...
SOC 2는 감사인이 통제가 실제로 작동한다는 증거를 원할 때 사용하는 AICPA 프레임워크입니다. 보안, 가용성, 처리 무결성, 기밀성, 개인정보 보호의 다섯 가지 신뢰 서비스 기준을 다룹니다.
...
포크는 변경 관리를 감사 가능하게 만듭니다. 각 포크는 라이브 상태의 복사본으로 테스트하고, 검토하고, 승격하거나 폐기할 수 있으며, 모든 단계에 행위자와 함께 타임스탬프가 찍힙니다.
