...
Ao registar-se, o Rediacc cria automaticamente uma organização para si. A sua organização é o contentor de nível superior para todos os recursos -- máquinas, repositórios, subscrições e membros de equipa.
