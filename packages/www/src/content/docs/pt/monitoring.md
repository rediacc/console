...
O comando imprime o hostname remoto em caso de sucesso e um erro de
conexão caso contrário, o que verifica o DNS, a porta SSH e a
autenticação por chave num único passo.
