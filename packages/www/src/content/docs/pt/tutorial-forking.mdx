...
Esta é a parte que muda a forma como trabalha. Clone um ambiente de produção inteiro -- a aplicação, a base de dados, os ficheiros de configuração -- em segundos. Qualquer tamanho. Zero disco extra. Faça fork quantas vezes quiser.
