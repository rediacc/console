...
- Edgeでは有料プランは利用できず、アカウントはCommunityプランで運用されます。
...
| **Communityプラン制限** | リポジトリ10GB、月100回のセットアップ、マシン1台 | リポジトリ20GB、月200回のセットアップ、マシン2台 |
...
CommunityプランでEdgeを利用すると、リソース制限が2倍になります：
