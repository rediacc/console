...
| 完全性制御 | [45 CFR 164.312(c)](https://www.govinfo.gov/content/pkg/PLAW-104publ191/html/PLAW-104publ191.htm) | CoWスナップショットが変更前の元データを保持。`rdc repo admin validate`がリポジトリの完全性とバックアップの健全性（LUKSコンテナ、ファイルシステムの一貫性、設定）を検証。 |
