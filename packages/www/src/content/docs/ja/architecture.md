...
オペレーター向けの実用的なルールについては、[rdc vs renet](/en/docs/rdc-vs-renet) を参照してください。また、`rdc ops` を使用してテスト用のローカルVMクラスターを実行することもできます。[実験的VM](/en/docs/experimental-vms) を参照してください。
