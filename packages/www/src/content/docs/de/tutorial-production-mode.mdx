...
Wenn Sie noch eine aktive `renet dev up`-Sitzung im Repo haben, beenden Sie diese zuerst mit `rdc vscode connect my-app` gefolgt von `renet dev down`. Danach wird alles vollständig von Ihrem Laptop aus gesteuert.
