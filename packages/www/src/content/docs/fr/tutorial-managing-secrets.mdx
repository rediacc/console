...
Si vous vous souvenez de l'ancienne valeur, prouvez-le plutôt avec `--current <old-value>`. C'est la voie la plus sûre. Elle détecte l'erreur "je suis dans le mauvais terminal".
