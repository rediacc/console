...
| Contrôles d'intégrité | [45 CFR 164.312(c)](https://www.govinfo.gov/content/pkg/PLAW-104publ191/html/PLAW-104publ191.htm) | Les snapshots CoW préservent les données originales avant modification. `rdc repo admin validate` vérifie l'intégrité du dépôt et la santé des sauvegardes (conteneur LUKS, cohérence du système de fichiers, configuration). |
