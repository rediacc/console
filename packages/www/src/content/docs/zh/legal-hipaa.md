...
| 完整性控制 | [45 CFR 164.312(c)](https://www.govinfo.gov/content/pkg/PLAW-104publ191/html/PLAW-104publ191.htm) | CoW 快照在修改前保存原始数据。`rdc repo admin validate` 验证仓库完整性和备份健康状况（LUKS 容器、文件系统一致性、配置）。 |
