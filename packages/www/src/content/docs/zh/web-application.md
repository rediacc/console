...
![Rediacc 登录页面 - 始终在线的基础设施](/assets/images/UserGuideEng/01_login.png)
...
![Rediacc 登录表单 - 邮箱和密码字段](/assets/images/UserGuideEng/02_register.png)
*（图 2：现有用户的登录屏幕）*
...
![创建账户模态框 - 注册、验证和完成步骤](/assets/images/UserGuideEng/03_create_account.png)
...
![验证码输入 - 6 位激活码](/assets/images/UserGuideEng/04_verification_code.png)
*（图 4：输入发送给管理员的激活码的窗口）*
...
![登录表单 - 带错误警告的必填字段](/assets/images/UserGuideEng/05_sign_in.png)
...
![Rediacc 仪表板 - 机器列表和侧边栏菜单](/assets/images/UserGuideEng/06_dashboard.png)
...
![用户创建模态框 - 邮箱和密码字段](/assets/images/UserGuideEng/08_user_add.png)
...
![用户列表 - 包含三个用户的完整表格视图](/assets/images/UserGuideEng/09_user_list.png)
...
![权限分配模态框 - 管理员组](/assets/images/UserGuideEng/11_user_permissions_form.png)
...
![用户追踪 - 带操作按钮的"追踪"工具提示](/assets/images/UserGuideEng/14_users_trace.png)
*（图 14：用户活动追踪选项）*
...
![新团队创建表单 - 团队名称和 SSH 密钥](/assets/images/UserGuideEng/16_teams_create.png)
*（图 16：在"私有团队"内创建新团队）*
...
![团队编辑表单 - 蓝色信息消息](/assets/images/UserGuideEng/17_teams_edit_form.png)
*（图 17：编辑现有团队的信息）*
...
![团队成员管理表单 - "当前成员"和"添加成员"标签](/assets/images/UserGuideEng/18_teams_members_form.png)
*（图 18：团队成员管理面板）*
...
![机器页面 - "添加机器"按钮](/assets/images/UserGuideEng/23_machines_add.png)
*（图 23：机器管理主页）*
...
![机器添加表单 - 所有字段](/assets/images/UserGuideEng/24_machine_create.png)
...
![连接测试按钮](/assets/images/UserGuideEng/26_connectivity_test_button.png)
...
![刷新按钮](/assets/images/UserGuideEng/28_refresh.png)
*（图 28：机器操作工具栏中的刷新按钮）*
...
![编辑按钮](/assets/images/UserGuideEng/31_edit_button.png)
*（图 31：机器操作列中的铅笔图标）*
...
![机器编辑表单](/assets/images/UserGuideEng/32_edit_form.png)
...
![追踪按钮](/assets/images/UserGuideEng/33_trace_button.png)
*（图 33：机器操作列中的时钟图标）*
...
![删除按钮](/assets/images/UserGuideEng/35_delete_button.png)
*（图 35：机器操作列中的垃圾桶图标）*

3. 在确认窗口中点击 **{{t:common.delete}}** 按钮。

![机器删除确认窗口](/assets/images/UserGuideEng/36_delete_form.png)
...
*（图 38：Setup 函数 - 使用所需工具和配置准备机器）*

> **提示**：设置新机器时建议首先运行"setup"函数。
...
![高级函数列表](/assets/images/UserGuideEng/41_remote_advanced.png)
*（图 41：高级选项 - 高级函数列表）*
...
![远程菜单 - 测试连接](/assets/images/UserGuideEng/42_connectivity_test.png)
*（图 42：从远程菜单选择测试连接选项）*
...
![创建仓库按钮](/assets/images/UserGuideEng/43_create_repo_add.png)
...
![仓库列表](/assets/images/UserGuideEng/46_repo_list.png)
*（图 46：创建的仓库出现在列表中）*
...
![Fork 完成](/assets/images/UserGuideEng/49_repo_completed.png)
*（图 49：Fork 操作成功完成）*
...
![Up 操作](/assets/images/UserGuideEng/50_repo_up.png)
*（图 50：从 fx 菜单选择"up"选项 - 启动仓库）*

2. 等待 **{{t:queue.statusCompleted}}** 消息。

![Up 完成](/assets/images/UserGuideEng/51_repo_up_complete.png)
*（图 51：仓库启动完成）*
...
![Down 操作](/assets/images/UserGuideEng/52_down_button.png)
*（图 52：从 fx 菜单选择"down"选项 - 关闭仓库）*

2. 等待 **{{t:queue.statusCompleted}}** 消息。

![Down 完成](/assets/images/UserGuideEng/53_down_completed.png)
*（图 53：仓库关闭完成）*
...
![Deploy 完成](/assets/images/UserGuideEng/56_deploy_completed.png)
*（图 56：仓库部署完成）*
...
![Backup 操作](/assets/images/UserGuideEng/57_backup_button.png)
...
![Backup 完成](/assets/images/UserGuideEng/59_backup_completed.png)
*（图 59：备份任务成功完成）*
...
1. 选择仓库并按照 **fx** > **Templates** 路径。

![Templates 操作](/assets/images/UserGuideEng/60_templates_button.png)
*（图 60：从 fx 菜单选择"Templates"选项）*
...
![模板已应用](/assets/images/UserGuideEng/62_templates_completed.png)
*（图 62：模板应用成功完成）*
...
![Unmount 完成](/assets/images/UserGuideEng/64_unmount_completed.png)
*（图 64：卸载操作完成）*
...
![Expand 表单](/assets/images/UserGuideEng/66_expand_form.png)
*（图 66：用于增加仓库大小的新大小参数）*
...
![Expand 完成](/assets/images/UserGuideEng/67_expand_completed.png)
*（图 67：仓库扩展完成）*
...
![Rename 表单](/assets/images/UserGuideEng/69_rename_form.png)
*（图 69：输入新仓库名称的对话框）*
...
![追踪按钮](/assets/images/UserGuideEng/83_credentials_trace_button.png)
*（图 83：凭证表中的"追踪"按钮）*
...
![删除按钮](/assets/images/UserGuideEng/85_credentials_delete.png)
*（图 85：凭证页面上的红色"删除"按钮）*

3. 在确认窗口中点击 **{{t:common.delete}}** 按钮。

![删除确认](/assets/images/UserGuideEng/86_credentials_delete_confirm.png)
...
![队列页面](/assets/images/UserGuideEng/87_queue_button.png)
*（图 87：队列页面 - 过滤选项和状态标签）*
...
![审计列表](/assets/images/UserGuideEng/89_audit_list.png)
