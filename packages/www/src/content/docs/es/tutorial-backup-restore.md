...
La misma lógica que un [fork](/en/docs/tutorial-forking). `rdc` primero hace un fork y luego sube el fork. El fork captura el momento; tu app en vivo sigue funcionando. Sin tiempo de inactividad, sin inconsistencias.
...
Siguiente: [Monitoreo](/en/docs/tutorial-monitoring).
