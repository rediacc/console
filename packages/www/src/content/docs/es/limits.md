...
Los puertos solo se abren una vez que configura una IP pública con `rdc machine infra set <machine> --public-ipv4`. Hasta entonces, no hay puertos abiertos en la máquina. Una vez configurado:
