...
Si recuerdas el valor anterior, demuéstralo en cambio con `--current <old-value>`. Ese es el camino más seguro. Captura el error de "estoy en la terminal equivocada".
