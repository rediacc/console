...
| Reclaimable | La diferencia entre lo asignado y lo usado que [`repo trim`](/es/docs/repositories#reclaim-space-trim) puede devolver al pool. Muestra `-` para repositorios desmontados |
