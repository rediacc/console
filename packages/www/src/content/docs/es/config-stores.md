---
title: "Config & Stores"
description: "Administra archivos de configuración de CLI y sincronízalos con backends externos como Git, Bitwarden, S3, HashiCorp Vault o archivos locales."
category: "Guides"
order: 8
language: es
...
El archivo de configuración predeterminado es `~/.config/rediacc/rediacc.json`. Puede crear configuraciones con nombre para diferentes entornos:
...
Almacena cada configuración como una **nota segura** separada en su bóveda de Bitwarden. Los elementos se nombran con el prefijo `rdc:` (p. ej., `rdc:rediacc`, `rdc:production`).
