...
لمعرفة كيفية تفعيل أو تعطيل التشغيل التلقائي لمستودع، راجع [الخدمات: التشغيل التلقائي عند الإقلاع](/ar/docs/services#autostart-on-boot).
...
- [الخدمات: التشغيل التلقائي عند الإقلاع](/ar/docs/services#autostart-on-boot): تفعيل وتعطيل التشغيل التلقائي وإدارة ملفات المفاتيح
