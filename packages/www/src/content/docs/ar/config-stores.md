---
title: "Config & Stores"
description: "إدارة ملفات إعدادات CLI ومزامنتها مع الواجهات الخلفية مثل Git وBitwarden وS3 وHashiCorp Vault أو الملفات المحلية."
category: "Guides"
order: 8
language: ar
...
ملف الإعدادات الافتراضي هو `~/.config/rediacc/rediacc.json`. يمكنك إنشاء إعدادات مسماة لبيئات مختلفة:
...
يخزن كل إعداد كملاحظة آمنة منفصلة في خزنة Bitwarden الخاصة بك. يتم تسمية العناصر ببادئة `rdc:` (مثلاً `rdc:rediacc`، `rdc:production`).
