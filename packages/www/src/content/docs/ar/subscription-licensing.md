...
**مستخدمو قناة Edge** يحصلون على ضعف حدود Community بلا تكلفة (مستودعات 20 GB، 200 إصدار/شهر، 4 أجهزة). الخطط المدفوعة متاحة فقط على قناة Stable. راجع [قنوات الإصدار](/ar/docs/release-channels) للتفاصيل.
