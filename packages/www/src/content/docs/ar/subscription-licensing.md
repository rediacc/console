...
يتم فرض تتبع فتحات الأجهزة من جانب الخادم. عندما يُصدر CLI ترخيص مستودع، يتحقق خادم الحساب من حصة فتحات الأجهزة للاشتراك (مثلاً، جهازان للـ Community، وخمسة للـ Professional). تُحتفظ بالفتحة لمدة ساعة واحدة من آخر إصدار ترخيص مستودع على ذلك الجهاز وتُحرَّر تلقائياً بعد الخمول. بالتالي يمكن لخطة 5 فتحات أن تغطي عشرات الأجهزة على مدار الوقت، لأن الفتحات تُحتفظ بها فقط أثناء التوفير النشط.
