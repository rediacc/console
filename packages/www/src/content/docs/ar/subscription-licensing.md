...
يبقى التطبيق مرناً. تستمر المستودعات قيد التشغيل في العمل حتى بعد انتهاء الاشتراك؛ فقط الأعمال الجديدة (الإنشاء والتفريع وتغيير الحجم وتجديد الترخيص) تخضع لاستحقاق نشط.
