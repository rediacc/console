...
يعتمد PCI DSS اعتماداً كبيراً على التجزئة: عزل بيئة بيانات حامل البطاقة (CDE)، وإلا فشلت في التدقيق. يمنحك Rediacc هذه التجزئة افتراضياً:
...
التجزئة الضعيفة والتشفير المفقود هي وراء أكثر إجراءات تنفيذ PCI DSS تكلفةً:
