...
> **ملاحظة:** بعد الحذف، يتم الاحتفاظ بإدخال الإعدادات (قد يكون المستودع موجوداً على أجهزة أخرى). استخدم `rdc config repository remove <name>` لإزالته، أو `--archive-config` للحفاظ على بيانات الاعتماد للاسترداد.
