...
- **اتصالات TCP**: يتم الحفاظ على اتصالات TCP النشطة عند الاستعادة على نفس الجهاز. عند الترحيل عبر الأجهزة، يجب إعادة إنشاء اتصالات TCP بواسطة التطبيق بعد الاستعادة.
