...
description: مزامنة مشفرة بدون معرفة للإعدادات باستخدام التشفير المبني على مفاتيح المرور
category: Guides
order: 8
language: ar
...
بعد الإعداد، تعمل عمليات واجهة سطر الأوامر اليومية (push/pull) بدون مفتاح المرور. ملاحظة مهمة: يتطلب الإعداد مفتاح مرور يدعم PRF. لا تدعم جميع مفاتيح الأجهزة ومصادقات المنصة هذا الامتداد.
