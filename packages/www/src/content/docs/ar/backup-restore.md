...
تعمل كل عملية push من لقطة مؤقتة لمخزن البيانات، بحيث تكون البيانات المرفوعة متسقة حتى وهي المستودعات تستمر في الكتابة. ما دامت النسخة الاحتياطية جارية، تبقى اللقطة تُشير إلى كل كتلة تشاركها مع المستودعات الحية: تُحرّر عمليات الحذف و[trim](/ar/docs/repositories#استرداد-المساحة-trim) مساحة أقل في التجمع حتى تنتهي الدورة وتُحذف اللقطة. يُظهر [تقرير صحة التخزين](/ar/docs/monitoring#صحة-التخزين) مقدار المساحة التي تحجزها لقطات النسخ الاحتياطي حالياً.
