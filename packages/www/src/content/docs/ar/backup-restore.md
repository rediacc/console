...
**الساخن** هو الإعداد الافتراضي الصحيح للتشغيلات عالية التكرار. تستمر الخدمات في العمل أثناء أخذ اللقطة، لذلا لا تُقاطع نافذة النسخ الاحتياطي المستخدمين. اللقطة متسقة عند التعطل: وهي مكافئة لما ستحصل عليه بعد إغلاق غير نظيف. وهذا مقبول لمعظم قواعد البيانات الحديثة وطوابير الرسائل.
