...
المستودع الذي لا تستبعده أي من الاستراتيجيتين تلتقطه كلتاهما، فتكون له لقطات ساعية متسقة عند التعطل ولقطة أسبوعية متسقة على مستوى التطبيق. يعرضهما `rdc backup snapshot list <repo>` معاً، وتُخزَّن الكتل المشتركة بينهما مرة واحدة.
