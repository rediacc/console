...
- **حجب الاتصالات بين المستودعات**: إذا حاولت خدمة الاتصال بعنوان IP استرجاعي خارج نطاق `/26` الخاص بمستودعها، تقوم النواة بحجبه. لا يمكن لعملية في المستودع (أ) الوصول إلى خدمات في المستودع (ب).
