...
| **A.12**، أمن العمليات | A.12.4 التسجيل والمراقبة | 70+ نوع حدث (المصادقة، رموز API، التكوين، الترخيص، عمليات الجهاز). مراقبة صحة الجهاز عبر `rdc machine query`. مراقبة حالة الحاويات والموارد. |
