...
عملياً، لا يملك مستخدمو الأنظمة الأخرى أي مهرب من تدفق العمل القائم على التفريع أولاً. هذا متعمَّد. لا توجد طريقة للوكيل لتجاوز صندوق الرمل بصرف النظر عن كيفية توجيهه. شغّل وكيلك داخل WSL أو حاوية Linux أو جهاز Linux افتراضي إذا كنت بحاجة إلى التجاوز؛ خلاف ذلك، اعمل على نسخة متفرعة.
