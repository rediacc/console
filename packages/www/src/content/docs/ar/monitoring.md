...
| Reclaimable | الفجوة بين Allocated والمستخدم فعلياً التي يستطيع [`repo trim`](/ar/docs/repositories#reclaim-space-trim) إعادتها إلى التجمع. يُعرض `-` للمستودعات غير المحمّلة |
