...
عبر أنظمة التشغيل الخمسة المدعومة رسمياً للخوادم (راجع [المتطلبات](/en/docs/requirements))، يستخدم Docker daemon الخاص بكل مستودع والحاويات التي يشغّلها **تسميات الحاويات الافتراضية**. لا يقوم `rdc config machine setup` بتثبيت سياسة SELinux مخصصة أو ملف تعريف AppArmor مخصص. وهذا بقصد: الحل الوسط هو أن عمليات الحاويات تعمل تحت سياسة التسمية الافتراضية لنظام التشغيل المضيف، وليس تحت ملف تعريف حبس محدد لـ Rediacc. إذا كان نموذج التهديد الخاص بك يتطلب مراقبة الوصول الإلزامية على مستوى الحاوية، فقم بتكوينها على مستوى المضيف قبل النشر.
