...
| **سلامة المعالجة** (PI1) | معالجة دقيقة وكاملة | تضمن خطافات دورة حياة Rediaccfile الحتمية (`up`/`down`) عمليات نشر متسقة. يتحقق `rdc repo admin validate` من سلامة المستودع وصحة النسخ الاحتياطية بعد عمليات الإغلاق غير المتوقعة أو عمليات النسخ الاحتياطي. |
...
4. ترقية النسخة إلى الإنتاج (`rdc repo promote`)
