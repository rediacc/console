...
| ضوابط النزاهة | [45 CFR 164.312(c)](https://www.govinfo.gov/content/pkg/PLAW-104publ191/html/PLAW-104publ191.htm) | تحافظ لقطات CoW على البيانات الأصلية قبل التعديلات. يتحقق `rdc repo admin validate` من سلامة المستودع وصحة النسخ الاحتياطية (حاوية LUKS، تناسق نظام الملفات، التكوين). |
