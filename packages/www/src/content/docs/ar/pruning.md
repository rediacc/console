...
يُزيل التنظيف الحالة المتبقية عن موارد محذوفة. لاستعادة المساحة التي تشغلها المستودعات *الحية* (كتل حررتها أنظمة ملفاتها لكن التجمع لا يزال يحتجزها)، استخدم [`rdc repo trim`](/ar/docs/repositories#reclaim-space-trim) بدلاً من ذلك؛ كلاهما متكاملان.
