...
Asendage `<machine>` ja `<repo>` oma tegelike masina ja repositooriumi nimedega. Käivitage `rdc repo list`, et kuvada saadaolevad repositooriumid koos nende nime-GUID-i vastavusega.
