...
On üks asi, mida fork tahtlikult ei järgi: saladused. Fork algab ilma API võtmete, andmebaasi paroolideta, Stripe' tokenideta. Sel põhjusel tegelikult toimib "kloonige tootmine, ärge rikuge midagi". Teie liivakast ei saa päris kliente arveldada, sest see ei saa väärata olevat te. Me seisime seda õigesti üles [Saladuste haldamise](/en/docs/tutorial-managing-secrets) õpetuses.
...
Järgmine: [Saladuste haldamine](/en/docs/tutorial-managing-secrets).
