...
Kui soovid saladusi forkis testimiseks, seadista need forkile selgelt liivakasti väärtustega, näiteks `rdc repo secret set my-app:test --key STRIPE_KEY --value sk_sandbox_yyy --mode file`. Nüüd suhtleb fork Stripe'i liivakastiga ja käivitub puhtalt. Tootmise mandaadid ei lahkunud kunagi tootmisest.
