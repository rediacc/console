...
Kaks asja, mida märgata: `--mode env` paneb väärtuse keskkondmuutujana konteinerisse ja `--current ""` deklareerib, et see on täiesti uus saladus ilma eelneva väärtuseta.
...
Kui mäletad vana väärtust, tõesta seda hoopis `--current <old-value>` abil. See on turvalisem tee. See tabab "olen vales terminalis" vea.
