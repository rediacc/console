...
|--------|-------------|---------|
| `--base <ref>` | Репозиторий для сравнения (базовая, старая сторона). По умолчанию — родитель позиционной ссылки, определяемый из локальной конфигурации. | родитель ссылки |
