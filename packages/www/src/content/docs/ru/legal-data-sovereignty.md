...
## Хостинговый сервис: региональная резидентность данных

Для пользователей хостингового сервиса Rediacc (в отличие от самостоятельно размещённого) резидентность данных обеспечивается за счёт региональной инфраструктуры. Доступны три региона: ЕС (Франкфурт), США (Вирджиния) и Азиатско-Тихоокеанский регион (Токио). Каждый регион использует независимые базы данных и хранилище без передачи данных между регионами. Транзакционные письма доставляются через AWS SES; ЕС и США используют выделенные региональные конечные точки, а Азиатско-Тихоокеанский регион использует конечную точку ЕС (eu-central-1). Регион ЕС применяет юрисдикционное принуждение к хранилищу R2. Полный технический разбор смотрите в разделе [Регионы данных](/ru/docs/data-regions).
