...
PCI DSS делает сильный акцент на сегментации: изолируйте среду данных держателя карты (CDE), или провалите аудит. Rediacc обеспечивает эту сегментацию по умолчанию:
...
Слабая сегментация и отсутствие шифрования стоят за наиболее дорогостоящими правоприменительными действиями PCI DSS:
