...
**Вариант B: Admin (межклиентский).** Служба поддержки Rediacc или системный администратор вышестоящего сервера может вызвать `POST /admin/delegation-certs` с теми же параметрами.
