...
description: "Резервное копирование зашифрованных репозиториев в любое совместимое с rclone хранилище, восстановление на любой машине и автоматизация с помощью именованных стратегий резервного копирования и таймеров systemd."
category: Guides
order: 7
language: ru
