...
| Право на удаление (1798.105) | Удаление персональных данных потребителя по запросу | `rdc repo delete` криптографически уничтожает зашифрованный том LUKS. Удаление форка полностью убирает клонированные копии. |
...
- `rdc machine query --name <machine> --repositories` выводит список всех репозиториев на машине с указанием размера и состояния монтирования
