...
description: >-
  Создание зашифрованного репозитория, развёртывание контейнерного приложения,
  инспекция контейнеров и очистка.
category: Tutorials
order: 3
language: ru
...
Каталог монтирования является местом расположения файлов приложения: `Rediaccfile`, `docker-compose.yml` и томов данных.
...
> **Примечание:** После удаления запись конфигурации сохраняется (репозиторий может существовать на других машинах). Используйте `rdc config repository remove --name <name>` для её удаления или `--archive-config` для сохранения учётных данных для восстановления.
...
- [Сервисы](/en/docs/services), справочник Rediaccfile, сети сервисов, автозапуск и многосервисные конфигурации
- [Руководство: Мониторинг и диагностика](/en/docs/tutorial-monitoring), проверки работоспособности, инспекция контейнеров и диагностика
- [Инструменты](/en/docs/tools), терминал, синхронизация файлов и интеграция с VS Code
