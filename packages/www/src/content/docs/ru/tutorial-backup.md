...
description: >-
  Настройте автоматические расписания резервного копирования, управляйте
  провайдерами хранения, настройте сетевую инфраструктуру и зарегистрируйте
  порты сервисов.
category: Tutorials
order: 6
language: ru
...
> **Раскладка hot и cold.** Когда стратегия использует `--mode hot`, резервные копии попадают в `<bucket>/<folder>/hot/<guid>` в хранилище; стратегии с `--mode cold` пишут в `<bucket>/<folder>/cold/<guid>`. Канонический шаблон. Одна почасовая hot-стратегия плюс одна еженедельная cold-стратегия. Полные подробности см. в разделе [Резервное копирование и восстановление. Раскладка хранилища](/ru/docs/backup-restore#раскладка-хранилища).
