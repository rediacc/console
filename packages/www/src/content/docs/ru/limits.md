...
- **TCP-соединения**: активные TCP-соединения сохраняются при восстановлении на той же машине. При миграции между машинами TCP-соединения должны быть заново установлены приложением после восстановления.
