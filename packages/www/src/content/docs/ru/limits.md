...
| Частота резервного копирования | Минимальный интервал не установлен; ограничен пропускной способностью вашего хранилища. Используйте `rdc backup strategy set <name> --bwlimit "6M"` для ограничения скорости загрузки (синтаксис rclone `--bwlimit`: простой `6M`, направленный `6M:off` или расписание `08:00,3M;22:00,10M`) |
