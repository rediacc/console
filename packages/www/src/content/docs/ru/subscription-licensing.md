...
Ограничения остаются мягкими. Работающие репозитории продолжают функционировать даже после окончания подписки; только новые операции (создание, форк, изменение размера и обновление лицензии) требуют активного права на использование.
