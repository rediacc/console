...
| Reclaimable | Разница между выделенным и использованным, которую [`repo trim`](/ru/docs/repositories#reclaim-space-trim) может вернуть в пул. Показывает `-` для размонтированных репозиториев |
