...
Хранилище конфигурации синхронизирует конфигурацию CLI между устройствами. Конфигурации шифруются на устройстве ключом шифрования содержимого (CEK), которым сервер никогда не владеет. Раздел [Безопасность](#security) точно указывает, от чего это защищает, а от чего — нет.
