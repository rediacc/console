...
|---|---|---|
| `rdc storage prune <storage> -m <machine>` | Архивные резервные копии в облачном хранилище | Локальная конфигурация CLI (перепроверяется на машине-исполнителе для безопасности монтирования) |
