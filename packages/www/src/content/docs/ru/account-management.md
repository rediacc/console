...
| PROFESSIONAL | 3 | 2 000+ | 60d / 120d | Группы разрешений, журнал аудита, кастомный брендинг, приоритетная поддержка |
| BUSINESS | 10 | 5 000+ | 90d / 180d | Ceph, расширенная аналитика, приоритет очереди, продвинутая очередь |
| ENTERPRISE | 25+ | 15 000+ | 120d / 365d | Выделенный менеджер аккаунта |
