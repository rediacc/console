...
О том, как включить или отключить автозапуск для репозитория, см. [Сервисы: Автозапуск при загрузке](/ru/docs/services#autostart-on-boot).
...
- [Сервисы: Автозапуск при загрузке](/ru/docs/services#autostart-on-boot): включение и отключение автозапуска, управление ключевыми файлами
