...
description: >-
  Depolama sağlığı raporumuz depoları GB başına neredeyse 20.000 extent ile
  işaretliyor. Her iki uçta da kıyaslama yaptım: okuma cezası sıfır. Rediacc'ın
  neden birleştirme komutu sunmadığı.
author: Rediacc
...
> **Özet.** Rediacc'ın `rdc machine status --storage-health` komutu, depo başına bir parçalanma rakamı raporlar. Bir üretim makinesinde GitLab'ı yaklaşık 19.650 extent/gigabyte ile işaretliyor. İçgüdü birleştirme yapmak. Ben ise ölçtüm.
>
