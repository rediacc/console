...
He dejado la sección anterior tal y como la escribí originalmente. La honestidad tenía sentido entonces. Desde la publicación, hemos lanzado la pieza que faltaba, y la brecha ya se puede cerrar: no cambiando cómo se comportan los forks, sino añadiendo un lugar para guardar las credenciales fuera de la imagen cifrada del repositorio.

El mecanismo es `rdc repo secret`. Está inspirado en los secretos de GitHub Actions. Dos cosas importan sobre cómo está construido.
