...
> **TL;DR.** Rediacc's `rdc machine status --storage-health` reports a fragmentation figure per repository. On one production machine it flags GitLab at roughly 19,650 extents per gigabyte. The instinct is to defragment. I measured it instead.
>
