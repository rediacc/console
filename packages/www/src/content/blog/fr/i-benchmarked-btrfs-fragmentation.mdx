...
description: >-
  Notre rapport de santé du stockage signale des dépôts à près de 20 000
  extents/Go. J'ai mesuré les deux extrêmes : pénalité de lecture nulle.
  Pourquoi Rediacc n'a pas de commande defrag.
author: Rediacc
...
featured: false
language: fr
sourceHash: "362ac76977739eb6"
sourceCommit: 8062f196566d6ba5f90b084e5484cf722b4bdf16
---

> **TL;DR.** `rdc machine status --storage-health` de Rediacc affiche un chiffre de fragmentation par dépôt. Sur une machine de production, il signale GitLab à environ 19 650 extents par gigaoctet. Le réflexe est de défragmenter. J'ai préféré mesurer.
>
