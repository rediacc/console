...
**Унифицированный журнал аудита.** Более 70 типов событий по всему control plane. Охватывают входы, API-токены, записи конфигурации, жизненный цикл репозитория, backup, синхронизацию, терминальные сессии и операции с машинами. Цепочка связана хешами на рабочей станции оператора. `rdc audit verify` проверяет её от начала до конца.
