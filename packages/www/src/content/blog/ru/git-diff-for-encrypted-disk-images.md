...
description: >-
  rdc repo diff сравнивает зашифрованные образы на уровне блоков и выдаёт список
  A/M/D/R. Ни один ключ не используется. Стоимость зависит от числа изменённых
  блоков, а не от размера репозитория.
author: Rediacc
