...
**النسخ الاحتياطي:** استراتيجيات النسخ الاحتياطي الساخن (لقطة BTRFS متسقة مع الأعطال، بلا توقف) والبارد (متسقة مع التطبيق عبر توقف-لقطة-تشغيل)، مجدولة عبر مؤقتات systemd، ومتعددة الوجهات عبر rclone. أحجام مشفّرة بـ LUKS؛ يحتفظ المشغّل بالمفتاح؛ شركة Rediacc لا ترى البيانات النصية أبداً. راجع [Backup & Restore](/ar/docs/backup-restore) و[Cross Backup Strategy](/ar/docs/cross-backup) للشكل التشغيلي.
...
**بيانات الاختبار والاستنساخ الكامل للبنية:** Fork قائم على BTRFS reflink، ثابت الوقت بصرف النظر عن حجم المستودع، كامل البنية (البيانات والتهيئات وحالة الحاويات والخدمات). 7.2 ثانية لاستنساخ مستودع بحجم 128 GB في [اختبار PocketOS](/ar/blog/i-tested-rediacc-against-the-pocketos-incident). الاستنساخ هو الإنتاج الحالي، لا بيئة تجهيز مختصرة. راجع [Risk-Free Upgrades](/ar/docs/risk-free-upgrades).
...
لتعيين القدرات على مواد NIS2 علنياً، راجع [NIS2 and DORA](/ar/docs/legal-nis2-dora). للإطار المعماري الأشمل، راجع [Compliance Overview](/ar/docs/legal-overview). للتفاصيل التجارية من جانب Rediacc، راجع [Subscription & Licensing](/ar/docs/subscription-licensing).
...
لـ [النسخ الاحتياطي بدون تكلفة إضافية](/ar/docs/zero-cost-backup) (الحجة المعمارية وراء سبب عملنا بشكل أخف من المنافسين على جانب التخزين)، و[Cross Backup Strategy](/ar/docs/cross-backup) (التعافي من الكوارث عبر القارات)، و[Subscription & Licensing](/ar/docs/subscription-licensing) (الجانب التجاري)، راجع المستندات المرتبطة.
