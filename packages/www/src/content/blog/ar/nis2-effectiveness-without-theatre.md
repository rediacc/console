...
**المخرج 1: وتيرة تدريبات التفريع**. سجل مُدرَّج زمنياً لتدريبات الفعالية المُجراة بوتيرة أسبوعية أو نصف أسبوعية على مدى اثني عشر شهراً متجددة. كل إدخال يُظهر مستودع الأصل ووسم الفرع والتصحيح أو التغيير الخاضع للاختبار ونتيجة اختبار الدخان وتوقيت التفكيك. سجل التدقيق الذي ينتجه `rdc config audit log --since` يلتقط كل هذا.

**المخرج 2: سجل تدقيق تلك التدريبات مرتبطاً بتسلسل تجزئة**. سلسلة التجزئة في سجل التدقيق هي ما يحوّل "أجرينا 47 تدريباً العام الماضي" من مجرد ادعاء إلى دليل. `rdc config audit verify` يتحقق من صحة السلسلة من البداية إلى النهاية. نتيجة التحقق هي مخرج أمر واحد يستطيع المدقق إعادة تشغيله.
