...
للاطلاع على قصة الاسترداد الأشمل بما فيها تدريبات عبر الأجهزة وعبر القارات، راجع [استراتيجية النسخ الاحتياطي المتقاطع](/ar/docs/cross-backup) و[النسخ الاحتياطي والاستعادة](/ar/docs/backup-restore). للاطلاع على دلالات النقطة الزمنية خلال حدث تلف جزئي، راجع [استعادة السفر عبر الزمن](/ar/docs/time-travel-recovery).
...
للاطلاع على نطاق جانب المشتريات (الاعتمادات وإدارة المخاطر والامتثال وانهيار سجل الموردين)، راجع [منشور سلسلة التوريد](/ar/blog/nis2-supply-chain-self-hosted). للاطلاع على نطاق جانب التكلفة (ما يبقى في الميزانية بعد مستوى التحكم المستضاف ذاتياً)، راجع [منشور الفاتورة الحقيقية](/ar/blog/nis2-the-real-bill).
...
للاطلاع على خريطة القدرات العامة لمواد NIS2، راجع [NIS2 وDORA](/ar/docs/legal-nis2-dora).
