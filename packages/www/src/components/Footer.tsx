      ...
      <div className="footer-container">
        <div className="footer-columns">
          ...
          <nav className="footer-column" aria-labelledby="footer-product-heading">
            <h4 className="footer-heading" id="footer-product-heading">{t('footer.columns.product')}</h4>
            <ul className="footer-list">
              <li>
          ...
          <nav className="footer-column" aria-labelledby="footer-org-heading">
            <h4 className="footer-heading" id="footer-org-heading">{t('footer.columns.organization')}</h4>
            <ul className="footer-list">
              <li>
                <a href={`/${currentLang}/contact`} className="footer-link">
          ...
          <nav className="footer-column" aria-labelledby="footer-support-heading">
            <h4 className="footer-heading" id="footer-support-heading">{t('footer.columns.support')}</h4>
            <ul className="footer-list">
              <li>
                <a href={`/${currentLang}/contact`} className="footer-link">
          ...
          <nav className="footer-column" aria-labelledby="footer-legal-heading">
            <h4 className="footer-heading" id="footer-legal-heading">{t('footer.columns.legal')}</h4>
            <ul className="footer-list">
              <li>
                <a href={`/${currentLang}/contact`} className="footer-link">
