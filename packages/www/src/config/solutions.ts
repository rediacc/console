...
export const SOLUTIONS = {
  'development-environments': {
    ...
    bottomImageAlt: 'Development environment automation dashboard showing ephemeral environments and cost savings',
    bottomImageVariant: 'dark' as const,
    problemKeys: ['provisioningDelays', 'environmentDrift', 'infrastructureCosts', 'cicdComplexity'],
  ...
  'disaster-recovery': {
    ...
    bottomImageAlt: 'Backup monitoring dashboard with extended retention timelines showing 100% verification',
    bottomImageVariant: 'dark' as const,
  ...
  'threat-response': {
    ...
    bottomImageAlt: 'Side-by-side comparison showing manual vs automated ransomware recovery timelines',
    bottomImageVariant: 'dark' as const,
  ...
  'data-security': {
    ...
    bottomImageAlt: 'Compliance dashboard showing migration status, audit trail, and encryption verification with SOC 2, ISO 27001, and GDPR badges',
  ...
  'system-portability': {
    ...
    bottomImageAlt: 'World map showing tested failover paths between AWS, Azure, and Google Cloud with verification checkmarks',
    bottomImageVariant: 'light' as const,
