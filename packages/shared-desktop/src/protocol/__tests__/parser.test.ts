...
describe('protocol/parser', () => {
  ...
  describe('parseProtocolUrl', () => {
    ...
    describe('path format parsing (token in path)', () => {
    ...
    describe('hostname format parsing (token as hostname)', () => {
    ...
    describe('action parsing', () => {
      ...
      it('should throw for invalid action', () => {
        // When there's a path after the "action" position, an invalid value throws
    ...
    describe('URL-encoded components', () => {
    ...
    describe('error handling', () => {
      it('should throw for missing team and machine', () => {
        ...
        expect(() => parseProtocolUrl(url)).toThrow('URL must contain at least token, team, and machine');
      });
