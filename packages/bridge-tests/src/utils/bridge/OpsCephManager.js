...
export class OpsCephManager {
    constructor(cephIPs, runOpsCommandWithEnv) {
        this.cephIPs = cephIPs;
        this.runOpsCommandWithEnv = runOpsCommandWithEnv;
    }
    /**
    ...
    async provision() {
        ...
        const result = await this.runOpsCommandWithEnv(['ceph', 'provision'], [], {}, 600000 // 10 minute timeout
        );
        if (result.code !== 0) {
...
//# sourceMappingURL=OpsCephManager.js.map
