...
export class BackupMethods {
    constructor(testFunction, testFunctionWithVault) {
        this.testFunction = testFunction;
        this.testFunctionWithVault = testFunctionWithVault;
    }
    /**
     * Push repository to a destination machine.
     * Uses backup_push with destinationType=machine.
     */
    async push(repository, destMachine, datastorePath) {
     ...
     */
    async pull(repository, sourceMachine, datastorePath) {
        return this.testFunction({
     ...
     */
    async pushWithOptions(repository, options) {
        return this.testFunction({
            function: 'backup_push',
            repository,
            ...options,
     ...
     */
    async pullWithOptions(repository, options) {
        return this.testFunction({
            function: 'backup_pull',
            repository,
            ...options,
     ...
     */
    async backup(repository, datastorePath, storageName) {
        return this.testFunction({
            function: 'backup_push',
            repository,
            datastorePath,
     ...
     * @deprecated Legacy wrapper - use pushWithOptions() directly
     */
    async deploy(repository, destMachine, datastorePath) {
        return this.testFunction({
            function: 'backup_push',
            repository,
            destMachine,
    ...
    async checkpointCreate(repository, checkpointName, datastorePath, networkId) {
        return this.testFunction({
    ...
    async checkpointRestore(repository, checkpointName, datastorePath, networkId) {
        return this.testFunction({
     ...
     */
    async pushWithVault(vault, timeout) {
     ...
     */
    async pullWithVault(vault, timeout) {
        return this.testFunctionWithVault('backup_pull', vault, timeout);
    }
}
//# sourceMappingURL=BackupMethods.js.map