 ...
 */
function convertPathForSSH(path: string, sshExecutable?: string): string {
 ...
 */
async function setupSSHAgentConnection(
  sshKey: string,
  known_hosts: string,
  port = 22,
  sshExecutable?: string,
 ...
 */
async function setupSSHConnection(
  sshKey: string,
  known_hosts: string,
  port = 22,
  sshExecutable?: string,
 ...
 */
async function cleanupSSHConnection(result: SSHSetupResult): Promise<void> {
