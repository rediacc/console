...
export const ErrorPatterns = {
  ...
  TOKEN_PRIVILEGE_INSUFFICIENT: "You can only create tokens for groups with equal or fewer privileges",
  ...
  // Rate limiting (429)
  QUEUE_RATE_LIMIT_EXCEEDED: "too many pending queue items",
  RATE_LIMIT_MAX_PENDING: "Maximum allowed is",

  // Storage limits
  STORAGE_LIMIT_EXCEEDED: "Resource limit exceeded for storages",
} as const;
