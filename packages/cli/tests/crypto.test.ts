...
describe('NodeCryptoProvider', () => {
  ...
  describe('encrypt/decrypt round-trip', () => {
    ...
    it('should encrypt and decrypt JSON object string', async () => {
  ...
  describe('error handling', () => {
    ...
    it('should fail with empty password for decryption', async () => {
      const encrypted = await nodeCryptoProvider.encrypt('secret data', testPassword);
    ...
    it('should fail with modified ciphertext (tampered data)', async () => {
      const encrypted = await nodeCryptoProvider.encrypt('secret', testPassword);
  ...
  describe('encryption format', () => {
    ...
    it('should produce output longer than 40 characters', async () => {
    ...
    it('should have consistent minimum output size', async () => {
  ...
  describe('password hashing', () => {
    ...
    it('should produce hex format with 0x prefix', async () => {
