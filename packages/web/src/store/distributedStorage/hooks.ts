...
export const useMachineSelection = (machines: Machine[] = []) => {
  ...
  const selectMachines = useCallback(
    (machineNames: string[]) => {
  ...
  const deselectMachines = useCallback(
    (machineNames: string[]) => {
...
export const useBulkOperationState = () => {
  ...
  const completeOperation = useCallback(
    (result: BulkOperationResult, addToHistory = true) => {
...
export const useMachineFilters = () => {
  ...
  const updateSingleFilter = useCallback(
    (key: MachineFilterKey, value: MachineFilterValue | undefined) => {
