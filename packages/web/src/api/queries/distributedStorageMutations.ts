...
export const useUpdateDistributedStorageClusterVault = createDistributedStorageMutation<UpdateClusterVaultData>({
  request: (data) => api.distributedStorage.updateClusterVault(data.clusterName, data.clusterVault, data.vaultVersion),
  operation: 'update',
...
export const useCreateDistributedStoragePool = createDistributedStorageMutation<CreatePoolData>({
  request: (data) => api.distributedStorage.createPool(data.teamName, data.clusterName, data.poolName, data.poolVault),
  operation: 'create',
  resourceKey: 'pool',
...
export const useUpdateDistributedStoragePoolVault = createDistributedStorageMutation<UpdatePoolVaultData>({
  request: (data) =>
    api.distributedStorage.updatePoolVault(data.teamName, data.poolName, data.poolVault, data.vaultVersion),
  operation: 'update',
...
export const useDeleteDistributedStorageRbdImage = createDistributedStorageMutation<DeleteImageData>({
  request: (data) => api.distributedStorage.deleteImage(data.poolName, data.teamName, data.imageName),
  operation: 'delete',
  resourceKey: 'rbdImage',
...
export const useUpdateMachineDistributedStorage = createDistributedStorageMutation<UpdateMachineStorageData>({
  request: (data) => api.machines.updateDistributedStorage(data.teamName, data.machineName, data.clusterName),
  operation: 'update',
...
export const useUpdateMachineClusterAssignment = createDistributedStorageMutation<MachineClusterData>({
  request: (data) => api.machines.updateClusterAssignment(data.teamName, data.machineName, data.clusterName),
  operation: 'assign',
