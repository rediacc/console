...
export const useUpdateBridgeVault = createVaultUpdateMutation<{
  ...
  'Bridge',
  (data) => api.bridges.updateVault(data.regionName, data.bridgeName, data.bridgeVault, data.vaultVersion),
  'bridgeName',
  'bridgeVault'
)
...
export const useResetBridgeAuthorization = createMutation<{
  ...
  request: ({ regionName, bridgeName }) =>
    api.bridges.resetAuthorization(regionName, bridgeName),
