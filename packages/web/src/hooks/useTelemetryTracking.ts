...
export const useTelemetryTracking = () => {
  ...
  const trackResourceCreation = useCallback(
  ...
  const trackResourceUpdate = useCallback(
    (resourceType: string, resourceName: string) => {
  ...
  const trackResourceDeletion = useCallback(
    (resourceType: string, resourceName: string) => {
  ...
  const trackQueueAction = useCallback(
    (action: string, details?: TelemetryAttributes) => {
  ...
  const trackQueueItemSubmission = useCallback(
    (functionName: string, priority: number) => {
  ...
  const trackQueueMonitoring = useCallback(
    (itemCount: number, filterType?: string) => {
  ...
  const trackFeatureAccess = useCallback(
    (featureName: string) => {
  ...
  const trackDataImport = useCallback(
    (importType: string, recordCount: number, success: boolean) => {
  ...
  const trackSettingsChange = useCallback(
    (settingCategory: string, settingName: string, newValue: string) => {
  ...
  const trackTableOperation = useCallback(
    (operation: string, tableName: string, recordCount: number, duration?: number) => {
  ...
  const trackAuditAccess = useCallback(
    (auditType: string, resourceType?: string) => {
  ...
  const trackStorageOperation = useCallback(
    (operation: string, details?: TelemetryAttributes) => {
