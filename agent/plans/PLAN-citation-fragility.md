...
- 2026-09-23T10:29:00Z record-sig re-derived by d778be9d from a0c54f71, the remedy check:ci-plan-record R7 names: the `done=` pointers were repointed to a later attesting commit and the signature was not re-derived with them. The box signatures and their `done=` proofs are untouched; only the line that attests them is brought back into agreement.
