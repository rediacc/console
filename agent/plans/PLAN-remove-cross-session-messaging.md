...
Priority: P2 -- seed: Status draft, 0 open box(es), a recent operator order
Concurrency: exclusive -- operator ruling 2026-09-26: every plan runs alone while the token budget is limited for the next few days
Owns: .claude/hooks/stop/*.py, .claude/rediacc_hooks/lifecycle.py, .claude/skills/migrate/SKILL.md, .claude/hooks/stop, .claude/settings.json, .claude/rediacc_hooks/guards/block_shell_background_waiter.py, .claude/rediacc_hooks/tests/*.py, .claude/rediacc_hooks/hookio.py, .claude/rediacc_hooks/guards/block_unverified_push.py, .claude/rediacc_hooks/guards/block_self_matching_pgrep.py, .claude/hooks/trapguard/dispatch.py, .ci/scripts/ci/ci-trace.py, .ci/rediacc_ci/quality/hook_integrity.py, .ci/rediacc_ci/review/standing_orders_brief.py, .ci/rediacc_ci/tests/test_review_standing_orders_brief.py, .ci/rediacc_ci/tests/goldens/standing-orders-brief/poll-has-content.golden, docs/agent-reference/TRAPS.md, docs/agent-reference/ci-gates.md, docs/agent-reference/worklist-v10-brief.md, .claude/skills/ci-watch/SKILL.md, .ci/config/*.json, .ci/policy/worklist-env-registry.json, scripts/data/hook-inventory-baseline.json, scripts/data/doc-registry-preport.json, scripts/data/doc-registry.md, scripts/data/shape-duplication-seed-advisory.json, .claude/rediacc_hooks/tests, .ci/scripts/quality/check_python_env_registry.py, .ci/scripts/quality/check_python_types.py, .ci/scripts/quality/check_prose_style.py, scripts/gen/gen-docs.ts, scripts/gen/gen-manifest.ts
