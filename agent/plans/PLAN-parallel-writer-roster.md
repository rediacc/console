...
- [x] Add the templates `V_ROSTER_CAP`, `V_ROSTER_STATUS`, `V_ROSTER_SILENT`, `V_ROSTER_UNLEASED`, `V_ROSTER_DEAD` and `N_ROSTER_HONEST` to `.claude/hooks/stop/worklist_messages.py`. Each must name the exact ids and commands.
    (earlier tick, re-investigated 2026-09-24) 2026-09-24T08:59:00Z by d778be9d: .claude/hooks/stop/worklist_messages.py line 2682 (blob d04fe08cdd5db7d93488ad7feae83d97e73e8082) V_ROSTER_CAP onward; .claude/rediacc_hooks/tests/test_wl_poll_and_waiting.py line 624 (blob 644924843f5ffc42817d1799bd39ea26b5e5980d) test_117 arity passes (pytest exit 0)
    (ticked) 2026-09-24T14:15:08Z by d778be9d: investigated present at U: .claude/hooks/stop/worklist_messages.py:2396, ae8238589; the roster messages V_ROSTER_CAP and siblings are in worklist_messages.py; the earlier pointer :2682 went stale when the messaging removal shortened the file
...
- [x] After 1.3 lands, extend the `bg-report` suppression at `wl_checks.py` :2650 with `roster_covers_all(live_bg)`, keeping 1.3's restamp on both branches.
    (ticked) 2026-09-24T08:59:01Z by d778be9d: .claude/hooks/stop/wl_checks.py:2695 roster_covers_all term; .claude/rediacc_hooks/tests/test_wl_background_waits.py line 1189 (blob 908418654f10b5e3c5ebc25360f4cd020091b2e7) test_13h passes (pytest exit 0), it failed while roster_covers_all used rows instead of verified
