...
- [x] Add the templates `V_ROSTER_CAP`, `V_ROSTER_STATUS`, `V_ROSTER_SILENT`, `V_ROSTER_UNLEASED`, `V_ROSTER_DEAD` and `N_ROSTER_HONEST` to `.claude/hooks/stop/worklist_messages.py`. Each must name the exact ids and commands.
    (earlier tick, re-investigated 2026-09-24) 2026-09-24T08:59:00Z by d778be9d: .claude/hooks/stop/worklist_messages.py line 2682 (blob d04fe08cdd5d) V_ROSTER_CAP onward; .claude/rediacc_hooks/tests/test_wl_poll_and_waiting.py line 624 (blob 644924843f5f) test_117 arity passes (pytest exit 0)
