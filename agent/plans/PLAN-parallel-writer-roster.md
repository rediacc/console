...
- [ ] Add the templates `V_ROSTER_CAP`, `V_ROSTER_STATUS`, `V_ROSTER_SILENT`, `V_ROSTER_UNLEASED`, `V_ROSTER_DEAD` and `N_ROSTER_HONEST` to `.claude/hooks/stop/worklist_messages.py`. Each must name the exact ids and commands.
