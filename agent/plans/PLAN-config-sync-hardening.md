...
Concurrency: parallel. Four writers: A (server), B (CLI and shared), C (harness), and the lead. Their Owns do not overlap. The harness (C) lands first with its failing scenarios marked; every fix task turns its scenarios green.
