...
Status: done -- all 9 boxes closed 2026-09-23. The section-4 sweep runs clean because the 2026-09-22 cleanup retired the whole flat-stub class it iterates over, not because its two regex bugs got fixed; they became moot once their subject stopped existing.
