...
- [ ] **P1.8 Waiters count as live worker ids.** Add `wl_liveness.live_worker_ids(event, live_bg, cwd, sid)`, the union of `live_bg` ids and `wl_roster.shell_waiters`. Use it at `wl_checks.py:1939` and `:2261`.
