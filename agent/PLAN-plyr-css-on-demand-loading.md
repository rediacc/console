...
`TutorialVideoPlayer.tsx:23-24` imports `plyr/dist/plyr.css` and `../styles/tutorial-video.css` at module scope. Those become one emitted chunk, **37,018 B raw / 6,087 B gzip** (plyr 32,428 B; tutorial-video.css 4,590 B).
