...
3 record(s): 3 compacted, 0 parked. A parked record stays on the housekeeping clock on purpose -- its work is not finished, only its text is compacted.
...
| `.github/workflows/ci-quality.yml` | agent/PLAN-lint-css-ci-wiring.md, agent/PLAN-lint-rule-matrix-probe.md |
...
| `eslint.config.js` | agent/PLAN-lint-rule-matrix-probe.md |
| `package.json` | agent/PLAN-lint-rule-matrix-probe.md |
| `packages/www/package.json` | agent/PLAN-lint-css-ci-wiring.md |
| `packages/www/src/components/solution-pages/SPHowItWorks.astro` | agent/PLAN-lint-css-ci-wiring.md |
| `scripts/ci-runner/manifest.ts` | agent/PLAN-lint-css-ci-wiring.md, agent/PLAN-lint-rule-matrix-probe.md |
...
| `agent/PLAN-greenlight-verify-at-read.md` | compacted | 37 | 0 | 0 | 2874 |
...
| `agent/PLAN-lint-css-ci-wiring.md` | compacted | 37 | 0 | 0 | 3597 |
| `agent/PLAN-lint-rule-matrix-probe.md` | compacted | 37 | 0 | 0 | 2941 |
