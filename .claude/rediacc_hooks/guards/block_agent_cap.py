...
REFUSED = (
    ...
    "%s\n"
    "\n"
    "First, write the refused work down so a compaction cannot lose it:\n"
    "  - add it to the Claude todo list (TodoWrite or TaskCreate, whichever this session\n"
    "    offers; one entry per refused spawn, naming its brief and the files it owns)\n"
    "  - and lease its worklist item to the queue: worklist.py --lease <me> <id> +120 worker:queue\n"
    "\n"
