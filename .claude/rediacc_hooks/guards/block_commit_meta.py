...
# The commit-verb gate is the whole 2026-08-27 fix. Without it the phrase test
# runs against every command again, so grepping the docs for the banned trailer
# is refused as though it were adding one.
...
# the claim -- written into that file -- that it is "unambiguous anywhere". It is
...
# single-line `--body '<trailer>: A <a@b.c>'` puts a REAL trailer mid-line,
