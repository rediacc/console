...
| `.ci/rediacc_ci/tests/gates` | pytest testpaths | 154 | 10 | 144 |
| `.ci/scripts/test/gates` | orphan gate | 13 | 13 | 0 |
| `.claude/hooks` | orphan gate | 12 | 0 | 0 |
...
17 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
