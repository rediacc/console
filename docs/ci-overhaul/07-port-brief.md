...
|---|---|---|---|---|
| `.ci/rediacc_ci/tests` | orphan gate + pytest | 288 | 0 | 288 |
...
| `.claude/rediacc_hooks/tests` | orphan gate + pytest | 59 | 0 | 59 |
...
| (unregistered) `.claude/hooks/stop/test-backlog.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-bgsweep.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-completion-evidence.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-defer-settle.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-deflect.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-judge-schema.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-plan-status-parse.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-plandeps.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-planenforce.py` | - | 1 | 0 | 0 |
...
| (unregistered) `.claude/hooks/stop/test-popup.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-reggate-ledger.py` | - | 1 | 0 | 0 |
| (unregistered) `.claude/hooks/stop/test-teammate-idle.py` | - | 1 | 0 | 0 |

23 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
