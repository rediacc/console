...
| `.ci/rediacc_ci/tests/gates` | pytest testpaths | 155 | 10 | 145 |
| `.ci/scripts/test/gates` | orphan gate | 15 | 15 | 0 |
| `.claude/hooks` | orphan gate | 14 | 1 | 0 |
| `.claude/rediacc_hooks/tests` | orphan gate + pytest | 12 | 0 | 12 |
...
18 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
