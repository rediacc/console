...
Supersedes `docs/agent/main/PLAN-unify-trap-corpus.md` (§9 says exactly which parts
...
- `docs/agent/main/REPORT-licensing-bigbang-2026-08-04.md:234`, under the heading
...
Instead, each `## ` entry in the single canonical `docs/agent/TRAPS.md` gains a
...
becomes *enumerable*: `grep -c 'JUDGMENT-ONLY' docs/agent/TRAPS.md` is the honest size
...
below. Output: one canonical `docs/agent/TRAPS.md` at 23 entries, the hook repointed,
...
`docs/agent/TRAPS.md:147`, measured cost three consecutive CI rounds that measured
...
in both corpora, `.agent/TRAPS.md:192` and `docs/agent/TRAPS.md:184`. Observed
...
- Canonical corpus at the tracked `docs/agent/TRAPS.md`; repoint the hook to it
