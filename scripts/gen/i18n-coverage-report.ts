 ...
 *
 * Usage:
 *   npx tsx scripts/gen/i18n-coverage-report.ts
 *   npx tsx scripts/gen/i18n-coverage-report.ts --json
 *
 * Exit codes:
...
function getLocaleKeysByNamespace(): Map<string, string[]> {
  ...
  // VACUITY FLOOR: a coverage report over zero locale files reports full coverage of nothing, which is the most convincing shape a broken glob can take.
