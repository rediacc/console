 ...
 *
 * Usage:
 *   npx tsx scripts/gates/check-translation-key-usage.ts
 ...
 * run: tsx scripts/gates/check-translation-key-usage.ts && tsx scripts/__tests__/check-translation-key-usage.control.ts
 * lane: quality-i18n
 * ---- end gate ----
 */
