 ...
 * BLOCKER comment, per the repo-wide BLOCKER convention (see docs/agent-reference/suppressions.md).
 *
 ...
 *
 * Usage: tsx scripts/gates/check-knip-blockers.ts [--config <path>]
 *
 * ---- gate ----
    ...
    try {
      out = execFileSync(
        ...
        [
          ...
          ':(exclude)scripts/gates/check-knip-blockers.ts',
        ],
