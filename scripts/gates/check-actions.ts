 ...
 * emit: false
 * blocker: BLOCKER: its `run:` goes through the `rediacc_ci.quality.run_external_gate` WRAPPER, which the derived run does not produce, and its `env:` block carries PROSE comments the `env-<KEY>:` grammar cannot hold.
