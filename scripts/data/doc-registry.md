...
30 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .ci/rediacc_ci/infra | 1 | .py 1 |
| .ci/rediacc_ci/quality | 89 | .py 89 |
| .ci/rediacc_ci/setup | 9 | .py 9 |
| .ci/rediacc_ci/tests | 103 | .py 103 |
...
| .ci/scripts/quality | 219 | .py 134, .sh 82, .json 2, .mjs 1 |
...
71 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
