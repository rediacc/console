...
| check:ci-account-env-retired | quality-security / Account env files retired | yes | no | no |
...
| check:ci-bash-lib-ported | quality-static / Bash-lib port completeness | yes | no | no |
...
| check:ci-cli-proxy-safe-output | quality-static / CLI proxy-safe output | yes | no | no |
...
| check:ci-proxy-image-smoke | local-only | yes | yes | no |
...
| check:ci-source-rules | local-only | no | no | no |
...
| check:test-workers | quality-www-build / Worker unit tests (workers/www, workers/proxy) | yes | yes | no |
...
359 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .claude/hooks/stop/wl_planindex.py | (none) | via .claude/hooks/stop/wl_backlog.py | py |
...
| .claude/rediacc_hooks/guards/block_agent_cap.py | (none) | via dispatch.py (glob) | py |
...
| .claude/rediacc_hooks/guards/block_ci_skip_token.py | (none) | via dispatch.py (glob) | py |
...
| .claude/rediacc_hooks/guards/block_commit_on_main.py | (none) | via dispatch.py (glob) | py |
...
| .claude/rediacc_hooks/guards/block_focus_spawn.py | (none) | via dispatch.py (glob) | py |
...
| .claude/rediacc_hooks/guards/block_git_hook_bypass.py | (none) | via dispatch.py (glob) | py |
...
| .claude/rediacc_hooks/guards/block_no_review_ineligible.py | (none) | via dispatch.py (glob) | py |
...
| .claude/rediacc_hooks/runningscript.py | (none) | via .claude/rediacc_hooks/guards/block_bash_write_to_running_script.py | py |
| .claude/rediacc_hooks/shellscan.py | (none) | via .claude/hooks/stop/wl_roster.py | py |
| .claude/rediacc_hooks/syspath.py | (none) | via .claude/hooks/context/onboard.py | py |
...
| .claude/rediacc_hooks/tests/goldenio.py | (none) | via .claude/rediacc_hooks/tests/test_golden_drift.py | py |
...
| .claude/rediacc_hooks/tests/regolden.py | (none) | via .claude/rediacc_hooks/tests/goldenio.py | py |
| .claude/rediacc_hooks/tests/test_bash_semantics.py | (none) | via pytest (testpaths) | py |
| .claude/rediacc_hooks/tests/test_dispatch.py | (none) | via pytest (testpaths) | py |
| .claude/rediacc_hooks/tests/test_golden_drift.py | (none) | via pytest (testpaths) | py |
| .claude/rediacc_hooks/tests/test_guard_chained_state.py | (none) | via pytest (testpaths) | py |
| .claude/rediacc_hooks/tests/test_guard_event_cwd.py | (none) | via pytest (testpaths) | py |
...
| .claude/rediacc_hooks/tests/test_wl_interim_reports.py | (none) | via pytest (testpaths) | py |
| .claude/rediacc_hooks/tests/test_wl_judge_fixset_scope.py | (none) | via pytest (testpaths) | py |
...
| .claude/rediacc_hooks/tests/test_wl_retro.py | (none) | via pytest (testpaths) | py |
| .claude/rediacc_hooks/tests/test_wl_roster.py | (none) | via pytest (testpaths) | py |
...
| .claude/rediacc_hooks/tests/test_wl_submodule_decision.py | (none) | via pytest (testpaths) | py |
...
243 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/config/carried-reds.json | 1 | JSON value |
...
39 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/config | 39 | .json 32, .txt 4, .conf 1, .sh 1, .yaml 1 |
| .ci/docker | 1 | .sh 1 |
...
| .ci/rediacc_ci/tests | 294 | .py 294 |
...
| .ci/shadow | 285 | .jsonl 284, .json 1 |
...
| `.ci/config/account-env-retired-baseline.json` | .ci/config | code: `.ci/rediacc_ci/quality/account_env_retired.py` | no -- hardcoded in `.ci/rediacc_ci/quality/account_env_retired.py` |
...
| `.ci/config/bash-lib-port-baseline.json` | .ci/config | code: `.ci/rediacc_ci/quality/bash_lib_migration_complete.py` | no -- hardcoded in `.ci/rediacc_ci/quality/bash_lib_migration_complete.py` |
| `.ci/config/bulk-transform-proof-baseline.json` | .ci/config | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
...
| `.ci/config/stop-hook.json` | .ci/config | code: `.claude/hooks/stop/worklist.py` | no -- hardcoded in `.claude/hooks/stop/worklist.py` |
...
| `scripts/data/css-dom-refs-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
| `scripts/data/dead-css-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
| `scripts/data/dead-translation-keys-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
...
| `scripts/data/docker-image-freshness-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
| `scripts/data/domain-layout-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
...
| `scripts/data/enumeration-vacuity-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
...
| `scripts/data/locale-de-contamination-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
...
| `scripts/data/sentence-wrapping-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
...
| `scripts/data/shell-declared-commands-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
| `scripts/data/static-nowrap-baseline.json` | scripts/data | code: `.claude/hooks/stop/wl_classsweep.py` | no -- hardcoded in `.claude/hooks/stop/wl_classsweep.py` |
...
70 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| `ACCOUNT_ED25519_PRIVATE_KEY_DEV` | secret | - |
| `ACCOUNT_ED25519_PUBLIC_KEY` | secret | - |
| `ACCOUNT_ED25519_PUBLIC_KEY_DEV` | secret | - |
| `ACCOUNT_ENTRY` | ci-runner | - |
| `ACCOUNT_JWT_SECRET` | secret | - |
| `ACCOUNT_JWT_SECRET_DEV` | secret | - |
| `ACCOUNT_SERVER_API_KEY` | secret | - |
| `ACCOUNT_SERVER_API_KEY_DEV` | secret | - |
| `ACCOUNT_X25519_PRIVATE_KEY` | secret | - |
| `ACCOUNT_X25519_PRIVATE_KEY_DEV` | secret | - |
| `ACCOUNT_X25519_PUBLIC_KEY` | secret | - |
| `ACCOUNT_X25519_PUBLIC_KEY_DEV` | secret | - |
...
| `AWS_SES_ACCESS_KEY_ID_BENCH` | secret | - |
...
| `AWS_SES_SECRET_ACCESS_KEY_BENCH` | secret | - |
...
| `BWS_ROTATE_TARGET_FILE` | harness | - |
| `CAMPAIGN` | tombstone | - |
| `CC_MUTABLE` | harness | - |
| `CEPH_MODE` | harness | - |
...
| `CLOUDFLARE_TURNSTILE_SECRET_KEY_BENCH` | secret | - |
...
| `COMMIT_POLICY_OK` | harness | - |
| `COMMIT_SHA` | ci-runner | - |
| `CONFIG_R2_ACCESS_KEY_ID` | harness | - |
| `CONFIG_R2_BUCKET` | harness | - |
| `CONFIG_R2_ENDPOINT` | harness | - |
| `CONFIG_R2_SECRET_ACCESS_KEY` | harness | - |
| `CONFIG_RUSTFS_PORT` | harness | - |
...
| `DEBUG` | harness | collision: dead in the rdc CLI, live in .ci/rediacc_ci/env/create_e2e_env.py |
...
| `OBS_OTLP_CREDENTIALS_BENCH` | secret | - |
...
| `PROMOTE_RETRY_DELAY_S` | ci-runner | - |
...
| `REDIACC_IN_DEVBOX` | harness | - |
| `REDIACC_KEY_USAGE_PROBE` | gate-seam | - |
| `REDIACC_LANE` | harness | - |
...
| `SERVICE_HTTP_PORT` | harness | - |
| `SERVICE_RUSTFS_CONSOLE_PORT` | harness | - |
| `SERVICE_STATUS_NOW` | gate-seam | - |
| `SERVICE_TAG` | harness | - |
| `SHADOW_FOREIGN_PID` | gate-seam | - |
| `SHADOW_PIDS` | gate-seam | - |
| `SHADOW_PRE` | gate-seam | - |
| `SHADOW_REAL_SLEEP` | gate-seam | - |
| `SHADOW_SHOW` | gate-seam | - |
...
| `STRIPE_E2E_WEBHOOK_SECRET` | harness | - |
...
| `WORKLIST_DEFER_SETTLE_BATCH` | harness | - |
| `WORKLIST_DEFER_SETTLE_CAP` | harness | - |
| `WORKLIST_DEFER_SETTLE_MIN` | harness | - |
...
970 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
