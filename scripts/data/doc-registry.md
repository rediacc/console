...
| .ci/policy | 21 | (none) 18, .json 2, .md 1 |
| .ci/prompts | 1 | .md 1 |
...
| .ci/rediacc_ci/quality | 96 | .py 96 |
...
| .ci/rediacc_ci/tests/gates | 161 | .py 160, .fixture 1 |
...
| .ci/scripts/autopilot | 16 | .sh 13, .cjs 2, .json 1 |
...
123 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
57 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
