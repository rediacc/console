...
350 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/rediacc_ci/quality | 101 | .py 101 |
...
| .ci/scripts/quality | 156 | .py 149, .sh 4, .json 2, .mjs 1 |
...
| .ci/shadow | 284 | .jsonl 283, .json 1 |
