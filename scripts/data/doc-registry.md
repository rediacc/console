...
481 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .claude/hooks/context/test-context-bands.py | (none) | via .claude/hooks/test-hooks.sh | py |
...
| .claude/hooks/stop/test-adhoc-watch.py | (none) | via .claude/hooks/test-hooks.sh | py |
| .claude/hooks/stop/test-always-tier.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
| .claude/hooks/stop/test-completion-evidence.py | (none) | via .claude/hooks/test-hooks.sh | py |
| .claude/hooks/stop/test-judge-schema.py | (none) | via .claude/hooks/stop/wl_shapedup.py | py |
| .claude/hooks/stop/test-plan-status-parse.py | (none) | via .claude/rediacc_hooks/guards/block_plan_without_tasks.py | py |
| .claude/hooks/stop/test-planfile.py | (none) | via .claude/hooks/stop/wl_planfile.py | py |
...
| .claude/hooks/stop/test-reggate-ledger.py | (none) | via .claude/hooks/test-hooks.sh | py |
| .claude/hooks/stop/test-report-inbox.sh | (none) | via .claude/hooks/stop/wl_report.py | sh |
| .claude/hooks/stop/test-teammate-idle.py | (none) | via .claude/hooks/stop/worklist-cases/18-identity.sh | py |
| .claude/hooks/stop/test-worklist-v5.sh | (none) | via .claude/hooks/stop/test-report-inbox.sh | sh |
| .claude/hooks/stop/wl_admit.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
...
| .claude/hooks/stop/wl_checks.py | (none) | via .claude/hooks/stop/test-plan-status-parse.py | py |
| .claude/hooks/stop/wl_ci.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
...
| .claude/hooks/stop/wl_judge.py | (none) | via .claude/hooks/stop/wl_agents.py | py |
| .claude/hooks/stop/wl_lineage.py | (none) | via .claude/hooks/stop/wl_core.py | py |
| .claude/hooks/stop/wl_liveness.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
| .claude/hooks/stop/wl_planfid.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
| .claude/hooks/stop/wl_planfile.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
| .claude/hooks/stop/wl_planindex.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
| .claude/hooks/stop/wl_planrec.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
| .claude/hooks/stop/wl_profile.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
| .claude/hooks/stop/wl_reggate.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
...
| .claude/hooks/stop/wl_shapedup.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
...
| .claude/rediacc_hooks/proc.py | (none) | via .claude/hooks/stop/wl_core.py | py |
...
| .claude/rediacc_hooks/tests/__init__.py | (none) | via .claude/hooks/stop/wl_git.py | py |
...
154 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .ci/policy/.language-policy-allowlist | 9 | # comment |
...
29 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .ci/config | 25 | .json 19, .txt 3, .conf 1, .sh 1, .yaml 1 |
| .ci/docker | 3 | .sh 3 |
...
| .ci/policy | 19 | (none) 16, .json 2, .md 1 |
| .ci/prompts | 1 | .md 1 |
| .ci/rediacc_ci | 13 | .py 13 |
| .ci/rediacc_ci/core | 10 | .py 10 |
| .ci/rediacc_ci/quality | 88 | .py 88 |
| .ci/rediacc_ci/setup | 9 | .py 9 |
| .ci/rediacc_ci/tests | 97 | .py 97 |
| .ci/rediacc_ci/tests/data | 2 | .json 1, .yml 1 |
| .ci/rediacc_ci/tests/gates | 87 | .py 87 |
...
| .ci/scripts/quality | 218 | .py 133, .sh 82, .json 2, .mjs 1 |
...
70 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| `knip.jsonc` | root | code: `.ci/scripts/ci/scope-map.cjs` | no -- hardcoded in `.ci/scripts/ci/scope-map.cjs` |
...
| `.ci/config/python-env-registry.json` | .ci/config | code: `.ci/rediacc_ci/quality/dead_python.py` | no -- hardcoded in `.ci/rediacc_ci/quality/dead_python.py` |
...
| `scripts/data/doc-registry-preport.json` | scripts/data | code: `.ci/scripts/test/gates/test-docs-gen.sh` | no -- hardcoded in `.ci/scripts/test/gates/test-docs-gen.sh` |
...
| `scripts/data/em-dash-surfaces-baseline.json` | scripts/data | code: `.ci/scripts/test/gates/test-shrink-only-composition.sh` | no -- hardcoded in `.ci/scripts/test/gates/test-shrink-only-composition.sh` |
...
55 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| `REDIACC_YES` | product-runtime | tombstone proof: `packages/cli/src/cli.ts` |
...
808 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
