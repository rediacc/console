...
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/audit-allowlist.list | 1 | prose only (no live entry) |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/audit-prod-allowlist.list | 6 | # comment |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/ci-config-directive-quotes-allowlist.list | 2 | prose only (no live entry) |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/ci-parity-exempt.list | 10 | # comment |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/cli-i18n-orphan-allowlist.list | 6 | inline |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/dead-bash-allowlist.list | 15 | # comment |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/deps-upgrade-blocklist.list | 11 | inline |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/devcontainer-upgrade-blocklist.list | 1 | prose only (no live entry) |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/e2e-coverage-allowlist.list | 3 | # comment |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/embed-assets-upgrade-blocklist.list | 1 | prose only (no live entry) |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/go-deps-upgrade-blocklist.list | 3 | # comment |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/plan-housekeeping-allowlist.list | 1 | prose only (no live entry) |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/profiler-coverage-allowlist.list | 4 | # comment |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/runner-advice-allowlist.list | 1 | prose only (no live entry) |
| .ci/rediacc_ci/tests/goldens/allowlist/corpus/unverified-download-allowlist.list | 4 | # comment |
...
39 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .ci/rediacc_ci/quality | 11 | .py 11 |
| .ci/rediacc_ci/tests | 21 | .py 21 |
