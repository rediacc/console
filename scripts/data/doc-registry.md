...
| check:ci-autopilot-bp-align | test: .ci/rediacc_ci/tests/gates/test_gate_autopilot_breakpoint_alignment.py | yes | no | no |
...
345 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .claude/hooks/context/epoch-reset.py | (none) | via .claude/rediacc_hooks/lifecycle.py | py |
| .claude/hooks/context/onboard.py | (none) | via .claude/rediacc_hooks/lifecycle.py | py |
...
| .claude/rediacc_hooks/guards/test-block_destructive_git_restore.py | (none) | via .claude/rediacc_hooks/tests/test_hooks_delegates.py | py |
| .claude/rediacc_hooks/guards/test-block_git_amend.py | (none) | via .claude/rediacc_hooks/tests/test_hooks_delegates.py | py |
| .claude/rediacc_hooks/guards/test-block_host_toolchain_run.py | (none) | via .claude/rediacc_hooks/tests/test_hooks_delegates.py | py |
| .claude/rediacc_hooks/guards/test-block_prose_style_commit.py | (none) | via .claude/rediacc_hooks/tests/test_hooks_delegates.py | py |
...
| .claude/rediacc_hooks/guards/test-block_push_to_protected_branch.py | (none) | (nothing) | py |
...
| .claude/rediacc_hooks/tests/wlfix.py | (none) | via .claude/rediacc_hooks/tests/test_hooks_delegates.py | py |
...
| .ci/config | 28 | .json 22, .txt 3, .conf 1, .sh 1, .yaml 1 |
| .ci/docker | 1 | .sh 1 |
...
| .ci/policy | 22 | (none) 18, .json 3, .md 1 |
| .ci/prompts | 1 | .md 1 |
...
| .ci/rediacc_ci/tests | 296 | .py 296 |
| .ci/rediacc_ci/tests/data | 2 | .json 1, .yml 1 |
| .ci/rediacc_ci/tests/gates | 172 | .py 171, .fixture 1 |
...
| .ci/rediacc_ci/tests/goldens/autopilot-gate | 120 | .golden 120 |
| .ci/rediacc_ci/tests/goldens/autopilot-push | 43 | .golden 43 |
| .ci/rediacc_ci/tests/goldens/autopilot-workflow-invariants | 26 | .golden 26 |
...
| .ci/rediacc_ci/tests/goldens/review-payload | 44 | .golden 44 |
...
| .ci/rediacc_ci/tests/goldens/submodule-prs | 21 | .golden 21 |
...
| .ci/shadow | 297 | .jsonl 296, .json 1 |
...
175 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
59 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
911 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
