...
458 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .claude/hooks/pre-bash/lib/command-scan.sh | (none) | via .claude/hooks/pre-bash/block-pathspecless-git-commit.sh | sh |
...
| .claude/hooks/stop/worklist_messages.py | (none) | via .claude/hooks/stop/wl_checklist.py | py |
...
153 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .ci/policy/.language-policy-allowlist | 4 | # comment |
...
| scripts/data/shape-duplication-seed.json | 20 | JSON value |

28 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .ci/config | 22 | .json 16, .txt 3, .conf 1, .sh 1, .yaml 1 |
| .ci/docker | 3 | .sh 3 |
...
| .ci/policy | 17 | (none) 16, .md 1 |
| .ci/prompts | 1 | .md 1 |
| .ci/rediacc_ci | 11 | .py 11 |
| .ci/rediacc_ci/core | 10 | .py 10 |
| .ci/rediacc_ci/quality | 78 | .py 78 |
| .ci/rediacc_ci/setup | 2 | .py 2 |
| .ci/rediacc_ci/tests | 92 | .py 92 |
| .ci/rediacc_ci/tests/data | 2 | .json 1, .yml 1 |
| .ci/rediacc_ci/tests/gates | 71 | .py 71 |
...
| .ci/scripts/quality | 134 | .sh 82, .py 49, .json 2, .mjs 1 |
