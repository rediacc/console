...
456 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| lib/sanctioned.py | (none) | via stop/wl_ci.py | py |
| post-bash/cancel-old-ci.sh | PostToolUse | settings.json | sh |
| post-bash/refresh-pr-body.sh | PostToolUse | settings.json | sh |
| pre-bash/block-pathspecless-git-commit.sh | PreToolUse | settings.json | sh |
| pre-bash/lib/command-scan.sh | (none) | via pre-bash/block-pathspecless-git-commit.sh | sh |
...
| stop/test-plan-status-parse.py | (none) | via test-hooks.sh | py |
...
| stop/test-worklist-v5.sh | (none) | via stop/test-report-inbox.sh | sh |
| stop/wl_admit.py | (none) | via stop/wl_checks.py | py |
| stop/wl_agents.py | (none) | via stop/wl_checks.py | py |
| stop/wl_bravedefault.py | (none) | via stop/test-judge-schema.py | py |
| stop/wl_checklist.py | (none) | via stop/worklist.py | py |
| stop/wl_checks.py | (none) | via stop/wl_checklist.py | py |
...
| stop/worklist_messages.py | (none) | via stop/wl_checklist.py | py |
| test-hooks.sh | (none) | via stop/wl_checks.py | sh |
| trapguard/dispatch.py | PostToolUse | settings.json | py |
| why-on-edit.py | PreToolUse | settings.json | py |

89 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
27 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
