...
348 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .claude/hooks/stop/wl_bgsweep.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
...
| .claude/hooks/stop/wl_deflect.py | (none) | via .claude/hooks/stop/wl_checks.py | py |
...
185 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/rediacc_ci/tests/gates | 170 | .py 169, .fixture 1 |
