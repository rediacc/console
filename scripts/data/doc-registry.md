...
| .claude/rediacc_hooks/guards/test-block_prose_style_commit.py | (none) | via .claude/hooks/test-hooks.sh | py |
| .claude/rediacc_hooks/guards/test-block_prose_style_edit.py | (none) | via .claude/hooks/test-hooks.sh | py |
| .claude/rediacc_hooks/guards/test-block_unproven_bulk_transform.py | (none) | via .claude/hooks/test-hooks.sh | py |
| .claude/rediacc_hooks/guards/test-block_unverified_push.py | (none) | via .claude/hooks/test-hooks.sh | py |
| .claude/rediacc_hooks/guards/test-warn_staged_shape_duplication.py | (none) | via .claude/hooks/test-hooks.sh | py |
...
| .claude/rediacc_hooks/tests/wlfix.py | (none) | via .claude/hooks/test-hooks.sh | py |

173 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/scripts/test/gates | 13 | .sh 13 |
...
115 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
