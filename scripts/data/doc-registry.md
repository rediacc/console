...
343 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .claude/hooks/stop/test-planfile.py | (none) | via .claude/hooks/stop/test-planrec.py | py |
...
179 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/scripts/quality | 153 | .py 141, .sh 9, .json 2, .mjs 1 |
...
| .ci/shadow | 279 | .jsonl 278, .json 1 |
...
156 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
922 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
