...
347 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
186 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| agent/ledgers/plan-investigation.jsonl | 1 | prose only (no live entry) |
| knip.jsonc | 26 | // comment |
| package.json | 28 | JSON value |
| scripts/ci-runner/gates.lock.json | 23 | JSON value |
| scripts/data/shape-duplication-seed.json | 11 | JSON value |

36 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/config | 32 | .json 25, .txt 4, .conf 1, .sh 1, .yaml 1 |
| .ci/docker | 1 | .sh 1 |
...
| .ci/rediacc_ci/tests/gates | 171 | .py 170, .fixture 1 |
...
| .ci/scripts/quality | 153 | .py 146, .sh 4, .json 2, .mjs 1 |
...
| TeammateIdle | 1 | 1 |
| (all events) | 11 | 5 |
| (tracked hook files nothing reaches) | - | 9 |
...
| `.ci/config/env-local-allowlist.json` | .ci/config | code: `.ci/rediacc_ci/tests/gates/test_gate_bws_map.py` | no -- hardcoded in `.ci/rediacc_ci/tests/gates/test_gate_bws_map.py` |
...
62 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| `BWS_ROTATE_ENV_FILE` | gate-seam | - |
| `BWS_ROTATE_GITMODULES` | gate-seam | - |
| `BWS_ROTATE_MIN_SECRETS` | gate-seam | - |
| `BWS_ROTATE_SECRET_MAP` | gate-seam | - |
| `CAMPAIGN` | tombstone | - |
| `CC_MUTABLE` | harness | - |
| `CEPH_MODE` | harness | - |
...
| `REDIACC_PID_WAIT_PROCFS` | gate-seam | - |
...
940 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
