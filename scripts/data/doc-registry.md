...
351 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
196 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/shadow/w7p5a-status.json | 15 | JSON value |
...
| .ci/rediacc_ci/quality | 102 | .py 102 |
...
| .ci/scripts/quality | 157 | .py 150, .sh 4, .json 2, .mjs 1 |
...
978 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
