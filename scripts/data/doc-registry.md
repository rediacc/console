...
| check:test-e2e-unit | local-only | yes | no | no |
| check:test-provisioning | local-only | yes | no | no |
...
455 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
139 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
68 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
