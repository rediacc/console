...
| gate-test:renet-pipefail-grep-q | quality-security / Quality-gate unit tests | yes | no | yes |
...
34 row(s). Generated by `npx tsx scripts/gen-docs.ts --write`; do not hand-edit.
...
| .ci/scripts/quality | 222 | .py 137, .sh 82, .json 2, .mjs 1 |
