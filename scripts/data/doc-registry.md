...
352 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/rediacc_ci/quality | 103 | .py 103 |
...
| .ci/scripts/quality | 158 | .py 151, .sh 4, .json 2, .mjs 1 |
