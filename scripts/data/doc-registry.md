...
172 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
...
| .ci/config | 27 | .json 21, .txt 3, .conf 1, .sh 1, .yaml 1 |
| .ci/docker | 1 | .sh 1 |
...
| .ci/rediacc_ci/quality | 99 | .py 99 |
...
58 row(s). Generated by `npx tsx scripts/gen/gen-docs.ts --write`; do not hand-edit.
