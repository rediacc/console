...
export interface GateSpec {
   ...
   * CI-side aggregate check:ci-quality-gates whose 59 constituents are
  ...
  paths?: string[];
  /** Set on the 59 entries flattened out of .ci/scripts/test/gates/. Their set
...
export const GATES: readonly GateSpec[] = [
  ...
  // The CI-side aggregate. gate:false because its 59 constituents are scheduled
