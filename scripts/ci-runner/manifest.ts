...
export const GATES: readonly GateSpec[] = [
  ...
  { id: 'check:ci-secret-reachability', run: 'npm run check:ci-secret-reachability', gate: true, leaves: ['.ci/scripts/quality/check_secret_reachability.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Secret reachability" } },
  { id: 'check:ci-scope-completeness', run: 'npm run check:ci-scope-completeness', gate: true, leaves: ['.ci/scripts/quality/check_scope_completeness.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Scope completeness" } },
