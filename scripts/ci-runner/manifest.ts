...
export const GATES: readonly GateSpec[] = [
  ...
  { id: 'check:ci-lint-scope-coverage', run: 'npm run check:ci-lint-scope-coverage', gate: true, leaves: ['.ci/scripts/quality/check_lint_scope_coverage.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Every source file reaches a linter" } },
