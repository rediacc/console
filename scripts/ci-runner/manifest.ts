...
export const GATES: readonly GateSpec[] = [
  ...
  { id: 'check:ci-probe-parity', run: 'npm run check:ci-probe-parity', gate: true, leaves: ['.ci/scripts/quality/check-probe-parity.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Capability-probe parity" } },
  { id: 'check:ci-drill-verdicts', run: 'npm run check:ci-drill-verdicts', gate: true, leaves: ['.ci/scripts/quality/check-drill-verdicts.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Drill verdict logic" } },
  { id: 'check:ci-account-probes', run: 'npm run check:ci-account-probes', gate: true, leaves: ['.ci/scripts/quality/check-account-probes.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Dev-stack liveness probes" } },
  ...
  { id: 'check:ci-secret-reachability', run: 'npm run check:ci-secret-reachability', gate: true, leaves: ['.ci/scripts/quality/check_secret_reachability.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: "Secret reachability" } },
  { id: 'check:ci-scope-completeness', run: 'npm run check:ci-scope-completeness', gate: true, leaves: ['.ci/scripts/quality/check_scope_completeness.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: "Scope completeness" } },
  { id: 'check:ci-hooks-resolvable', run: 'npm run check:ci-hooks-resolvable', gate: true, leaves: ['.ci/scripts/quality/check_hooks_resolvable.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Hooks resolvable" } },
  { id: 'check:ci-workflow-submodule-deps', run: 'npm run check:ci-workflow-submodule-deps', gate: true, leaves: ['.ci/scripts/quality/check_workflow_submodule_deps.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Workflow submodule deps" } },
  { id: 'check:ci-python-gate-deps', run: 'npm run check:ci-python-gate-deps', gate: true, leaves: ['.ci/scripts/quality/check_python_gate_deps.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Python gate deps" } },
  { id: 'check:ci-tutorial-cli-validity', run: 'npm run check:ci-tutorial-cli-validity', gate: true, leaves: ['.ci/scripts/quality/check_tutorial_cli_validity.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-content', step: "Tutorial CLI validity" } },
  { id: 'check:ci-e2e-case-blind', run: 'npm run check:ci-e2e-case-blind', gate: true, leaves: ['.ci/scripts/quality/check_e2e_case_blind_assertions.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-content', step: "E2E case-blind assertions" } },
  { id: 'check:ci-tutorial-no-skips', run: 'npm run check:ci-tutorial-no-skips', gate: true, leaves: ['.ci/scripts/quality/check_tutorial_no_skips.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-content', step: "Tutorials cannot skip themselves" } },
  { id: 'check:ci-dead-service-methods', run: 'npm run check:ci-dead-service-methods', gate: true, leaves: ['scripts/check-dead-service-methods.ts'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-content', step: "Dead service methods" } },
  { id: 'check:ci-retired-commands', run: 'npm run check:ci-retired-commands', gate: true, leaves: ['scripts/check-retired-commands-in-docs.ts'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-content', step: "Retired commands in docs" } },
  { id: 'check:ci-timeout-headroom', run: 'npm run check:ci-timeout-headroom', gate: true, leaves: ['.ci/scripts/quality/check_job_timeout_headroom.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "CI job timeout headroom" } },
  { id: 'check:ci-runner-advice', run: 'npm run check:ci-runner-advice', gate: true, leaves: ['.ci/scripts/quality/check_runner_advice.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Runner sizing advice" } },
  ...
  { id: 'gate-test:edge-verify-retries', run: '.ci/scripts/test/gates/test-edge-verify-retries.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-edge-verify-retries.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: "Quality-gate unit tests" } },
  { id: 'check:ci-review-turn-capacity', run: 'npm run check:ci-review-turn-capacity', gate: true, leaves: ['.ci/scripts/quality/check-review-turn-capacity.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Review turn budget cannot starve a routed review" } },
  { id: 'check:ci-review-cap-coherence', run: 'npm run check:ci-review-cap-coherence', gate: true, leaves: ['.ci/scripts/quality/check-review-cap-coherence.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Review cap is measured coherently" } },
  { id: 'check:ci-gate-reachability-coverage', run: 'npm run check:ci-gate-reachability-coverage', gate: true, leaves: ['.ci/scripts/quality/check_gate_reachability_coverage.py'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Gate-reachability probe agrees with registrations" } },
  ...
  { id: 'check:ci-tracked-sidecars', run: 'npm run check:ci-tracked-sidecars', gate: true, leaves: ['.ci/scripts/quality/check-tracked-sidecars.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-static', step: "Tracked runtime sidecars" } },
  ...
  { id: 'check:ci-docs-render-parity', run: 'npm run check:ci-docs-render-parity', gate: true, needs: ['build:www'], leaves: ['scripts/check-docs-render-parity.ts'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-www-build', step: "Docs render parity" } },
  ...
  { id: 'check:ci-page-locale-imports', run: 'npm run check:ci-page-locale-imports', gate: true, leaves: ['scripts/check-page-locale-imports.ts'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-i18n', step: "Page locale imports" } },
  ...
  { id: 'check:ci-autopilot-bp-align', run: 'npm run check:ci-autopilot-bp-align', gate: true, leaves: ['.ci/scripts/quality/check-autopilot-breakpoint-alignment.sh'], ci: { kind: 'test', test: '.ci/scripts/test/gates/test-autopilot-breakpoint-alignment.sh', blocker: "BLOCKER: test-autopilot-breakpoint-alignment.sh:59 runs the gate seam-free against the real .ci/breakpoint/workflow/breakpoint.yml and .github/workflows/autopilot.yml inside run-all.sh (ci-quality.yml quality-security, \"Quality-gate unit tests\"), so the real comparison executes every CI run; the mutated-copy cases around it prove both fire directions" } },
  ...
  { id: 'gate-test:autopilot-breakpoint-alignment', run: '.ci/scripts/test/gates/test-autopilot-breakpoint-alignment.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-autopilot-breakpoint-alignment.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:installmethods-args', run: '.ci/scripts/test/gates/test-installmethods-args.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-installmethods-args.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:installmethods-container-version', run: '.ci/scripts/test/gates/test-installmethods-container-version.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-installmethods-container-version.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:installmethods-linuxpkg-idiom', run: '.ci/scripts/test/gates/test-installmethods-linuxpkg-idiom.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-installmethods-linuxpkg-idiom.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:installmethods-manifest', run: '.ci/scripts/test/gates/test-installmethods-manifest.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-installmethods-manifest.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:releaseversion-attestation', run: '.ci/scripts/test/gates/test-releaseversion-attestation.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-releaseversion-attestation.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:releaseversion-build-version', run: '.ci/scripts/test/gates/test-releaseversion-build-version.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-releaseversion-build-version.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:releaseversion-cd-retry-assert', run: '.ci/scripts/test/gates/test-releaseversion-cd-retry-assert.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-releaseversion-cd-retry-assert.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:releaseversion-closure-untagged', run: '.ci/scripts/test/gates/test-releaseversion-closure-untagged.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-releaseversion-closure-untagged.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:releaseversion-inject-env', run: '.ci/scripts/test/gates/test-releaseversion-inject-env.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-releaseversion-inject-env.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:releaseversion-tag-fetch', run: '.ci/scripts/test/gates/test-releaseversion-tag-fetch.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-releaseversion-tag-fetch.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:stop-hook-stdin', run: '.ci/scripts/test/gates/test-stop-hook-stdin.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-stop-hook-stdin.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:verify-version', run: '.ci/scripts/test/gates/test-verify-version.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-verify-version.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:worklist-hooks', run: '.ci/scripts/test/gates/test-worklist-hooks.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-worklist-hooks.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:dispatch-release', run: '.ci/scripts/test/gates/test-dispatch-release.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-dispatch-release.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:detect-bump-type', run: '.ci/scripts/test/gates/test-detect-bump-type.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-detect-bump-type.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:external-gate-wrapper', run: '.ci/scripts/test/gates/test-external-gate-wrapper.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-external-gate-wrapper.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:greenlight-closure-trace', run: '.ci/scripts/test/gates/test-greenlight-closure-trace.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-greenlight-closure-trace.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:autopilot-guide-comment', run: '.ci/scripts/test/gates/test-autopilot-guide-comment.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-autopilot-guide-comment.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:label-guide-comment', run: '.ci/scripts/test/gates/test-label-guide-comment.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-label-guide-comment.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:label-inventory', run: '.ci/scripts/test/gates/test-label-inventory.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-label-inventory.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:dead-case-arms', run: '.ci/scripts/test/gates/test-dead-case-arms.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-dead-case-arms.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:label-references', run: '.ci/scripts/test/gates/test-label-references.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-label-references.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:preview-readiness', run: '.ci/scripts/test/gates/test-preview-readiness.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-preview-readiness.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:profiler-coverage', run: '.ci/scripts/test/gates/test-profiler-coverage.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-profiler-coverage.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:profiler-report', run: '.ci/scripts/test/gates/test-profiler-report.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-profiler-report.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  { id: 'gate-test:runner-advice', run: '.ci/scripts/test/gates/test-runner-advice.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-runner-advice.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:watchdog-no-retry-cancel', run: '.ci/scripts/test/gates/test-watchdog-no-retry-cancel.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-watchdog-no-retry-cancel.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
  ...
  { id: 'gate-test:watchdog-observer-exclusion', run: '.ci/scripts/test/gates/test-watchdog-observer-exclusion.sh', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-watchdog-observer-exclusion.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: 'Quality-gate unit tests' } },
