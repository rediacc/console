...
export const GATES: readonly GateSpec[] = [
  ...
  { id: 'check:ci-edge-verify-retries', run: 'npm run check:ci-edge-verify-retries', gate: true, qualityGateTest: true, leaves: ['.ci/scripts/test/gates/test-edge-verify-retries.sh'], ci: { kind: 'step', workflow: '.github/workflows/ci-quality.yml', job: 'quality-security', step: "Quality-gate unit tests" } },
