...
echo "------------------------------------------------------------"
echo ""
echo "DO NOT just add the '$SKIP_LABEL' label to bypass this check."
echo ""
echo "You MUST:"
...
echo ""
echo "Only after genuinely updating the description, add the label:"
echo "  gh pr edit $PR_NUMBER --add-label '$SKIP_LABEL'"
echo ""
echo "------------------------------------------------------------"
echo "FOR HUMANS:"
echo "------------------------------------------------------------"
...
echo ""
echo "Then add '$SKIP_LABEL' label to mark as reviewed."
echo ""
