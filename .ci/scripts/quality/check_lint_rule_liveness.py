...
list is precisely the artefact that misses a config block -- and asserts set equality between the enabled rules and the matrix in BOTH directions. It also
