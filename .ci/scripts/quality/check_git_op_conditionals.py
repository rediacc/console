...
THIS IS THE ONE PAIR OF THE SIX WHOSE STREAMS ARE NOT BYTE-IDENTICAL, and the difference is deliberate, documented in the port, and in the safe direction.
...
INVARIANT 5 IS INTACT: `.ci/scripts/quality/check-git-op-conditionals.sh` is NOT deleted here. It stays on disk as the differential twin, and as the one path the
