...
see it; the logic lives in `rediacc_ci.quality.config_migrations`, which pytest
...
and `python3 -m rediacc_ci.quality.config_migrations` works but is the wrong
...
INVARIANT 5 IS INTACT: `.ci/scripts/quality/check-config-migrations.sh` is NOT
