...
this port exit 0 with byte-identical stdout and byte-identical stderr. The RED
direction was driven too: handed a copy of `.ci/config/rubric-calibration.json`
