...
INVARIANT 5 IS DISCHARGED: `.ci/scripts/quality/check-rubric-calibration.sh` was the differential twin, and W7 P5 retired it; the shadow ledger under `.ci/shadow/` is the licence record.
