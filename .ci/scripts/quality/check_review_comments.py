...
INVARIANT 5 IS INTACT: `.ci/scripts/quality/check-review-comments.sh` is NOT deleted by this change. It stays on disk as the twin this port is proven against; deleting it is W7 P5's job, in a later change.
