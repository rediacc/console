...
---- gate ---- step: Tutorial healthcheck headroom run: .ci/scripts/quality/check_tutorial_healthcheck_headroom.py --selftest && .ci/scripts/quality/check_tutorial_healthcheck_headroom.py selftest: true needs: none lane: quality-packages ---- end gate ----
"""
