...
The logic lives in `rediacc_ci.quality.env_file_adoption`; this file exists so the
...
---- gate ---- step: Env file adoption needs: none lane: quality-static selftest: true
