...
Deliberately trivial: the gate needs a file whose content decides a fixture suite's verdict, so the mutation runner can be driven through all four of its outcomes in seconds instead of the 8-plus minutes a real suite costs.
"""
