...
#   CLOUDFLARE_R2_ACCESS_KEY_ID      exported to the validator as AWS_ACCESS_KEY_ID
#   CLOUDFLARE_R2_SECRET_ACCESS_KEY  exported to the validator as AWS_SECRET_ACCESS_KEY
#   CLOUDFLARE_R2_ENDPOINT           read directly by release-state-validator.sh
#
# Run locally (read-only, needs R2 credentials):
#   VERSION=v1.1.2 CLOUDFLARE_R2_ACCESS_KEY_ID=... CLOUDFLARE_R2_SECRET_ACCESS_KEY=... CLOUDFLARE_R2_ENDPOINT=... \
#     .ci/scripts/release/reprobe-r2-sentinel.sh
#
...
: "${CLOUDFLARE_R2_ACCESS_KEY_ID:?reprobe-r2-sentinel.sh: CLOUDFLARE_R2_ACCESS_KEY_ID must be set}"
: "${CLOUDFLARE_R2_SECRET_ACCESS_KEY:?reprobe-r2-sentinel.sh: CLOUDFLARE_R2_SECRET_ACCESS_KEY must be set}"
: "${CLOUDFLARE_R2_ENDPOINT:?reprobe-r2-sentinel.sh: CLOUDFLARE_R2_ENDPOINT must be set}"
