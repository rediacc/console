...
#   ACCOUNT_ED25519_PRIVATE_KEY        - Ed25519 private key for subscription signing
#   ACCOUNT_ED25519_PUBLIC_KEY         - Ed25519 public key for subscription verification
...
if [[ -z "${ACCOUNT_ED25519_PRIVATE_KEY:-}" ]]; then
    echo "ERROR: ACCOUNT_ED25519_PRIVATE_KEY is not set"
    echo "This must be configured as a GitHub secret"
    exit 1
fi
if [[ -z "${ACCOUNT_ED25519_PUBLIC_KEY:-}" ]]; then
    echo "ERROR: ACCOUNT_ED25519_PUBLIC_KEY is not set"
    echo "This must be configured as a GitHub secret"
    exit 1
fi
...
_PROD_ED25519_PRIVATE_KEY="$ACCOUNT_ED25519_PRIVATE_KEY"
_PROD_ED25519_PUBLIC_KEY="$ACCOUNT_ED25519_PUBLIC_KEY"
...
# =============================================================================
export ACCOUNT_ED25519_PRIVATE_KEY="$_PROD_ED25519_PRIVATE_KEY"
export ACCOUNT_ED25519_PUBLIC_KEY="$_PROD_ED25519_PUBLIC_KEY"
...
echo "Writing .env to $CI_DOCKER_DIR..."
{
    ...
    echo "ACCOUNT_ED25519_PRIVATE_KEY=${ACCOUNT_ED25519_PRIVATE_KEY}"
    echo "ACCOUNT_ED25519_PUBLIC_KEY=${ACCOUNT_ED25519_PUBLIC_KEY}"
    echo "ACCOUNT_X25519_PRIVATE_KEY=${ACCOUNT_X25519_PRIVATE_KEY:-}"
    echo "ACCOUNT_X25519_PUBLIC_KEY=${ACCOUNT_X25519_PUBLIC_KEY:-}"
    echo "ACCOUNT_SERVER_API_KEY=${ACCOUNT_SERVER_API_KEY}"
    echo "STRIPE_WEBHOOK_SECRET=${STRIPE_WEBHOOK_SECRET:-}"
    echo "ACCOUNT_JWT_SECRET=${ACCOUNT_JWT_SECRET}"
} >"$CI_DOCKER_DIR/.env"
