...
The twin's header, carried whole because the review quote, the narrowness argument, the accepted limitation and the subject change are each load-bearing:
    ...
    `scripts/gen/gen-gates-lock.ts` and kept faithful by `check:ci-gates-lock`, which
...
def evaluate(lock_path: str, pkg_path: str, gates_dir: str) -> tuple[list[str], list[str]]:
    ...
    try:
        ...
        out.append(
            ...
            "It is generated by scripts/gen/gen-gates-lock.ts; run check:ci-gates-lock."
            % (lock_path, exc)
        )
        return out, []
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not lock.is_file():
        return fail(
            ...
            "nothing. It is generated by scripts/gen/gen-gates-lock.ts and guarded by "
    ...
    if real_out:
        ...
        print(
            "  manifest.ts by scripts/gen/gen-gates-lock.ts; if it is stale, check:ci-gates-lock",
            file=sys.stderr,
        )
