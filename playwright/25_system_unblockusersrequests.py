...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(2)
    page2.get_by_test_id("main-mode-toggle").click()
    time.sleep(1)
    page2.get_by_text("System").click()
    time.sleep(1.5)
    page2.get_by_role("button", name="unlock Unblock User Requests").click()
    time.sleep(1)
    page2.get_by_role("button", name="Yes, Unblock").click()
    time.sleep(2)
