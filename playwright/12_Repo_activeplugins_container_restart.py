#!/usr/bin/env python3
"""
Container Restart Test - Fixed Version
Tests the container restart functionality in Rediacc console
"""
...
def run(playwright: Playwright) -> None:
    ...
    try:
        print("Starting Container Restart Test...")
        ...
        if not container_found:
            ...
            restart_option = page.get_by_text("container_restart")
            if restart_option.is_visible():
                ...
                print("    Container should be restarting now")
            else:
