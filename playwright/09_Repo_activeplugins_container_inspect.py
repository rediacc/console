#!/usr/bin/env python3
"""
Container Inspect Test - Fixed Version
...
def run(playwright: Playwright) -> None:
    ...
    try:
        print("Starting Container Inspect Test...")
        ...
        print("8. Looking for repositories...")
        try:
        ...
        # Try to find container action buttons
        container_selectors = [
        ...
        if not container_found:
            ...
            # Click container inspect option
            print("10. Clicking container_inspect...")
            time.sleep(0.5)  # Wait for menu
            
            inspect_option = page.get_by_text("container_inspect")
            if inspect_option.is_visible():
                inspect_option.click()
                print("    Container inspection initiated!")
                time.sleep(2)  # Wait for inspection results
            else:
                print("    Could not find container_inspect option")
