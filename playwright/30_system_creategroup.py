#!/usr/bin/env python3
"""
System Create Permission Group Test - Fixed Version
...
def run(playwright: Playwright) -> None:
    ...
    try:
        print("Starting System Create Permission Group Test...")
        ...
        screenshot_path = Path(__file__).parent / "artifacts" / "screenshots" / "system_creategroup_before_mode_switch.png"
            ...
            for selector in expert_radio_selectors:
                try:
                    ...
                    if expert_element.is_visible():
                        ...
                        screenshot_path_after = Path(__file__).parent / "artifacts" / "screenshots" / "system_creategroup_after_mode_switch.png"
        ...
        if not create_group_found:
            ...
            try:
                ...
                if group_name_input.is_visible():
                    group_name_input.fill("grup01")
                    group_name_filled = True
                    print("   Permission group name entered: grup01")
            except:
                # Try alternative selectors
                ...
                for selector in group_name_selectors:
                    try:
                        ...
                        if group_name_input.is_visible():
                            group_name_input.fill("grup01")
                            group_name_filled = True
                            print("   Permission group name entered using alternative selector: grup01")
                            break
                    except:
                        continue
            ...
            try:
                submit_button = page.get_by_test_id("modal-create-permission-group-ok")
                if submit_button.is_visible():
                    submit_button.click()
                    submit_found = True
        ...
        if 'page' in locals():
            ...
            screenshot_path = Path(__file__).parent / "artifacts" / "screenshots" / "error_screenshot_creategroup.png"
            page.screenshot(path=str(screenshot_path))
