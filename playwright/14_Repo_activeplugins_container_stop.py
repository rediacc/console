#!/usr/bin/env python3
"""
Container Stop Test - Fixed Version
Tests the container stop functionality in Rediacc console
"""
...
def run(playwright: Playwright) -> None:
    ...
    try:
        print("Starting Container Stop Test...")
        ...
        if 'page' in locals():
            ...
            screenshot_path = Path(__file__).parent / "artifacts" / "screenshots" / "error_screenshot_stop.png"
